<section class="content--section" id="content--section">
   <div class="container">
      ...
      <div class="row">
         ...
         {{-- search --}}
         <div class="col-3">
            <input wire:model.live='searchSide' class="form--input main-version mx-auto" type="search"
               style="width: 80% !important" placeholder="Search for Sides" />
         </div>
         ...
         <div class="col-2 text-start">
            <h3 class="fw-bold text-white scale--self-05 d-inline-block badge--scheme-2 px-3 rounded-1 mb-0 py-1"
               data-bs-toggle="tooltip" data-bss-tooltip="" title="Number of Sides">
               {{ $sides->total() }}
            </h3>
         </div>
      ...
      <div class="row row pt-2 align-items-center mb-5">
         ...
         <div class="col-12 mt-zone-cards plans-column" data-view="standard" data-instance="1">
            <div class="row pt-2 row align-items-center mb-4">
               ...
               <div class="col-4 col-xl-3 col-xxl-3" key='single-side-{{ $side->id }}'>
                  <div class="overview--card client-version scale--self-05 mb-floating">
                     <div class="row">
                        ...
                        <div class="col-12 text-center position-relative">
                           <div class="position-relative">
                              ...
                              <img class="client--card-logo"
                                 src="{{ url('storage/menu/meals/' . ($side->imageFile ?? $defaultPlate)) }}" />
                              ...
                              <button class="btn client--floating-button" type="button" data-bs-target="#menu-list"
                                 data-bs-toggle="modal" wire:click="editMenuList('{{ $side->id }}')">
                                 ...
                                 <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    class="bi bi-journal-check active" viewBox="0 0 16 16">
                        ...
                        <div class="col-12">
                           ...
                           <p class="text-center fs-13 fw-bold text-danger mb-0">
                              <button
                                 ...
                                 type="button">{{ $side->partType ?? 'Not Specified' }}</button>
                           </p>
                        </div>
                        ...
                        $initSideSizeId = $side?->sizes?->first()?->id ?? null;
                        ...
                        <div class="col-12">
                           <div class="tabs--wrap">
                              ...
                              <ul class="nav nav-tabs inner for-sizes" role="tablist">
                                 ...
                                 {{-- loop - sizes --}}
                                 @foreach ($side->sizes as $sideSize)
                                 <li class="nav-item" role="presentation">
                                    <a class="nav-link @if ($initSideSizeId == $sideSize->id) active @endif"
                                       data-bs-toggle="tab" href="#tab-1-{{ $sideSize->id }}" role="tab">
                                       {{ $sideSize->size->shortName }}
                                    </a>
                                 </li>
                                 @endforeach
                                 {{-- end loop --}}
                              ...
                              <div class="tab-content">
                                 ...
                                 @foreach ($side->sizes as $sideSize)
                                 <div
                                    class="tab-pane no--card py-0 px-3 @if ($initSideSizeId == $sideSize->id) active @endif"
                                    id="tab-1-{{ $sideSize->id }}" role="tabpanel">
                                    ...
                                    <div class="row">
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             ...
                                             <p class="fs-12">{{ $sideSize->afterCookCalories }}</p>
                                          </div>
                                       </div>
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             <h6 class="fs-12">P</h6>
                                             <p class="fs-12">{{ $sideSize->afterCookProteins }}</p>
                                          </div>
                                       </div>
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             <h6 class="fs-12">C</h6>
                                             <p class="fs-12">{{ $sideSize->afterCookCarbs }}</p>
                                          </div>
                                       </div>
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             <h6 class="fs-12">F</h6>
                                             <p class="fs-12">{{ $sideSize->afterCookFats }}</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-3">
                              ...
                              <a class="btn btn--scheme btn--theme fs-12 px-2 mx-1 scale--self-05 h-32"
                                 href="{{ route('dashboard.menuProductionBuilder', [$side->id]) }}">
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-1 scale--self-05 h-32"
                                 ...
                                 <svg class="bi bi-info-circle fs-5" xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" fill="currentColor" viewBox="0 0 16 16">
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-1 scale--self-05 h-32"
                                 data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="bottom" type="button"
                                 title="Print Side">
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-1 scale--self-05 h-32"
                                 data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="bottom" type="button"
                                 title="Preview">
                                 <svg class="bi bi-eye fs-5" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                              ...
                              <button class="btn btn--scheme btn--remove fs-12 px-2 mx-1 scale--self-05 h-32"
                                 wire:loading.attr='disabled' type="button" wire:click='remove({{ $side->id }})'>

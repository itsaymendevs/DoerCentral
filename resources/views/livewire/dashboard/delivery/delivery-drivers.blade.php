...
<section class="content--section" id="content--section">
   <div class="container">
      ...
      {{-- :: SubMenu --}}
      <livewire:dashboard.delivery.components.sub-menu title="Manage Drivers" key='submenu' />
      ...
      <div class="row align-items-end">
         ...
         <div class="col-3">
            <button class="btn btn--scheme btn--scheme-2 px-3 scalemix--3 py-2 d-inline-flex align-items-center"
               data-bs-target="#new-driver" data-bs-toggle="modal" type="button"><svg
                  class="bi bi-plus-circle-dotted fs-5 me-2" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
         ...
         <div class="col-6 text-center">
            <input class="form-control form--input main-version mx-auto" type="search"
               wire:model.live.debounce.50ms='searchDriver' placeholder="Search by Driver">
         </div>
         ...
         <div class="col-3 text-end">
            <h3 class="fw-bold text-white scale--self-05 d-inline-block badge--scheme-2 px-3 rounded-1 mb-0 py-1"
               data-bs-toggle="tooltip" data-bss-tooltip="" title="Number of Drivers">{{ $drivers->total() }}</h3>
         </div>
      ...
      <div class="row pt-2 align-items-center mb-4">
         ...
         <div class="col-12 mt-zone-cards">
            <div class="row pt-4 row align-items-center mb-3">
                     ...
                     <div class="row">
                        ...
                        <div class="col-12">
                           ...
                           <h6 class="text-center fw-bold mt-3 mb-1
                                    truncate-text-1l fs-15">{{ $driver->name }}</h6>
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-3">
                              ...
                              {{-- 1: edit --}}
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-4 mx-2 scale--self-05 h-32 mb-0 "
               ...
               <div class="col-12">{{ $drivers->links() }}</div>

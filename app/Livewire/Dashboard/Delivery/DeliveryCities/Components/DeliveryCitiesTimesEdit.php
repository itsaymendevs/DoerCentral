...
class DeliveryCitiesTimesEdit extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.delivery.delivery-cities.components.delivery-cities-times-edit', compact('city'));

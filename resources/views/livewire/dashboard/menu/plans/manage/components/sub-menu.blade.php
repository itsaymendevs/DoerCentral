...
<div class="row mb-submenu" wire:ignore>
   ...
   <div class="col-4">
      <div class="btn-group submenu--group" role="group" data-aos="flip-up" data-aos-duration="600" data-aos-delay="800"
         ...
         <a wire:navigate class="btn submenu--group btn--scheme-2 d-flex align-items-center" role="button"
            href="{{ route('dashboard.menuPlans') }}"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
               fill="currentColor" viewBox="0 0 16 16" class="bi bi-arrow-up-left me-2">
   ...
   <div class="col-8 text-end">
      <div class="btn-group submenu--group" role="group" data-aos="flip-up" data-aos-duration="600" data-aos-delay="800"
         ...
         {{-- intakeSizes --}}
         <a wire:navigate class="btn @if (Request::is('dashboard/menu/plans/' . $id . '/intake-sizes')) active @endif"
            role="button" href="{{ route('dashboard.menuPlanIntakeSizes', [$id]) }}">Intake Sizes</a>


         {{-- bundleCalendars --}}
         <a wire:navigate class="btn" role="button"
            href="{{ route('dashboard.menuPlanCalendars', [$id]) }}">Calendars</a>

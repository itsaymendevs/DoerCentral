<div class="modal fade modal--shadow" id="edit-timing" role="dialog" tabindex="-1" wire:ignore.self>
      ...
      <div class="modal-content">
         <div class="modal-body py-0 px-0">
            ...
            <header class="modal--header px-4">
               <h5 class="mb-0 fw-bold text-white">Edit Timing</h5>
            ...
            <form class="px-4" wire:submit='update'>
               <div class="row row pt-2 mb-4">
                  ...
                  <div class="col-4">
                     ...
                     <input class="form-control form--input mb-4" type="text" required wire:model='instance.title' />
                  </div>

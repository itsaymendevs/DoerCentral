...
<tr>
   ...
   <td class="fw-bold">
      <div class="form-check form-switch form-check-inline input--switch">
         <input class="form-check-input pointer" id="formCheck-{{ $instance->weekday }}" type="checkbox"
            @if ($instance->isActive) checked @endif wire:change='toggleActive({{ $instance->id }})'>
         <label class="form-check-label d-none" for="formCheck-{{ $instance->weekday }}">Label</label>
      </div>
   </td>

...
class IngredientsBrands extends Component
{
    ...
    public function store()
    {
        ...
        // 1: makeRequest
        $response = $this->makeRequest('central/dashboard/inventory/ingredients/brands/store', $this->instance);
    ...
    public function render()
    {
        ...
        return view('livewire.central.dashboard.inventory.ingredients.components.ingredients-brands', compact('brands'));

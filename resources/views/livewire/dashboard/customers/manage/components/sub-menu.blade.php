...
<div class="row align-items-end mb-submenu" wire:ignore>
   ...
   <div class="col-9 text-end">
      <div class="btn-group submenu--group" role="group" data-aos="flip-up" data-aos-duration="600" data-aos-delay="800"
         ...
         {{-- 4: history --}}
         <a class="btn fs-13 @if (Request::is('dashboard/customers/' . $id . '/history')) active @endif" role="button"
            href="#!">History</a>



         {{-- 5: calendar --}}
         <a wire:navigate class="btn fs-13 @if (Request::is('dashboard/customers/' . $id . '/calendar')) active @endif"
            role="button" href="{{ route('dashboard.singleCustomerCalendar', [$id]) }}">Calendar</a>



         {{-- 6: address --}}
         <a class="btn fs-13 @if (Request::is('dashboard/customers/' . $id . '/addresses')) active @endif" role="button"
            href="{{ route('dashboard.singleCustomerAddresses', [$id]) }}">Address</a>
      </div>
   </div>
   {{-- end otherLinks --}}

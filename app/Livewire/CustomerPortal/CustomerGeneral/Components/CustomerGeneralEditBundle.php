...
class CustomerGeneralEditBundle extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.customer-portal.customer-general.components.customer-general-edit-bundle', compact('mealTypes', 'types'));

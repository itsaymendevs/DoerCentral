               ...
               <div class="row align-items-start pt-2 mb-4">
                  ...
                  <div class="col-4">
                     ...
                     <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                        ...
                        <input class="form-control d-none file--input" id="driver--file-1"
                           data-preview="driver--preview-1" type="file" wire:model='instance.imageFile' required />
                  ...
                  <div class="col-4">
                     ...
                     <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                        ...
                        <input class="form-control d-none file--input" id="license--file-1"
                           data-preview="license--preview-1" type="file" wire:model='instance.licenseFile' required />
                  ...
                  <div class="col-4">
                     ...
                     <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                        ...
                        <input class="form-control d-none file--input" id="license--file-2"
                           data-preview="license--preview-2" type="file" wire:model='instance.licenseRearFile'
                           required />
                        ...
                        {{-- preview --}}
                        <img class="inventory--image-frame" id="license--preview-2"
                           src="{{ url('assets/img/placeholder.png') }}" wire:ignore />
                  ...
                  <div class="col-12 text-center mt-4">
                     <button
                        ...
                        wire:target='store, instance.imageFile, instance.licenseFile, instance.licenseRearFile'>
                        Save
                     </button>
                  </div>

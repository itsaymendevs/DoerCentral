<div>
    ...
    <nav>
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item page-item-theme disabled" aria-disabled="true"
            ...
            <li class="page-item  page-item-theme disabled" aria-disabled="true"><span class="page-link">{{ $element
                    }}</span></li>
            @endif
            ...
            <li class="page-item page-item-theme active"
                wire:key="paginator-{{ $paginator->getPageName() }}-page-{{ $page }}" aria-current="page"><span
                    class="page-link">{{ $page }}</span></li>
            @else
            <li class="page-item page-item-theme" wire:key="paginator-{{ $paginator->getPageName() }}-page-{{ $page }}">

...
namespace App\Livewire\Dashboard\Inventory\Settings;
...
class ConversionIngredients extends Component
{
    ...
    public function confirmRemove()
    {
        ...
        if ($this->removeToken) {
            ...
            // 1.2: makeRequest
            $response = $this->makeRequest('dashboard/inventory/settings/conversions/ingredients/remove', $this->removeToken);
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.inventory.settings.conversion-ingredients', compact('ingredients', 'cookingTypes'));

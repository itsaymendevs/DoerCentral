...
class IngredientsCreate extends Component
{
    ...
    public function store()
    {
        ...
        // 1.2: makeRequest
        $response = $this->makeRequest('central/dashboard/inventory/ingredients/store', $this->instance);
    ...
    public function render()
    {
        ...
        return view('livewire.central.dashboard.inventory.ingredients.components.ingredients-create', compact('units'));

   ...
   <div class="container">
      ...
      <form wire:submit='update' class="row align-items-start pt-3 row mb-5">
                  ...
                  <div class="row">
                     ...
                     <div class="col-6">
                        <div class="input--with-label mb-4">
                           <label class="form-label form--label mb-0">
                              <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                 viewBox="0 0 16 16" class="bi bi-telephone fs-6">
                                 <path
                           ...
                           <input type="text" class="form--input" required wire:model='instance.phone' minlength='9'
                              maxlength='9' />
                        </div>
                     </div>
                     ...
                     <div class="col-6">
                        <div class="input--with-label mb-4">
                           <label class="form-label form--label mb-0">
                              <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                 viewBox="0 0 16 16" class="bi bi-whatsapp fs-6">
                                 <path
                           ...
                           <input type="text" class="form--input" required wire:model='instance.whatsapp' minlength='9'
                              maxlength='9' />
                        </div>
                     </div>
                     ...
                     <div class="col-12">
                        <div class="w-100 mx-auto d-flex align-items-center justify-content-around mt-2">
                           ...
                           <div class="form-check form-switch mb-3 mealType--checkbox">
                              <input class="form-check-input pointer" wire:model='instance.isVIP' type="checkbox"
                                 id="formCheck-1" @if($instance->isVIP) checked @endif />
                           ...
                           <div class="form-check form-switch mb-3 mealType--checkbox">
                              <input class="form-check-input pointer" wire:model='instance.isEnabled' id="formCheck-2"
                                 type="checkbox" @if($instance->isEnabled) checked @endif
                              />
                     ...
                     <div class="col-6">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-1">
                           <hr style="width: 65%" />
                           <label class="form-label form--label px-3 w-50 justify-content-center mb-0">Manager</label>
                        </div>
                     ...
                     <div class="col-6">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-1">
                           <hr style="width: 65%" />
                           <label class="form-label form--label px-3 w-50 justify-content-center mb-0">Driver</label>
                        </div>
         ...
         <div class="col-12 col-xl-2 text-center order-first order-xl-2 mb-5 mb-xl-0">
            ...
            <img class="w-100 of-contain" src='{{ url("assets/img/Customers/{$customer->gender}.png") }}'
               style="height: 250px" />
         ...
         <div class="col-12 col-xl-5 order-xl-3" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true"
               ...
               <div class="col-4">
                  <div class="item--box p-0 pt-2 d-flex flex-column no-events customers--meal-types-wrapper">
                     ...
                     <img class="of-contain px-3 w-100"
                        src='{{ url("storage/types/{$subscriptionTypesByType->first()->type->imageFile}") }}'
            ...
            <div class="row mb-5">
               ...
               <div class="col-5">
                  <img class="w-100 of-contain" src='{{ url("storage/bags/{$coolBag->imageFile}") }}'
                     style="height: 130px" />
               </div>

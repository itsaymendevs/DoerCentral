                     ...
                     <div class="row">
                        ...
                        <div class="col-12 text-center position-relative">
                           <img class="client--card-logo smaller"
                              src="{{ url('storage/delivery/vehicles/profiles/' . $vehicle->imageFile) }}">
                        </div>
                           ...
                           <p class="text-center fs-13 fw-bold text-danger">
                              <span class="fs-12 fw-semibold text-warning pointer" data-bs-toggle="tooltip"
                                 ...
                                 title="{{ '-' }}">Drivers<svg class="bi bi-eye-fill fs-6 ms-1"
                                    style="fill: var(--bs-warning);" xmlns="http://www.w3.org/2000/svg" width="1em"
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-3">
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-3 mx-1 scale--self-05 h-32 mb-0 "

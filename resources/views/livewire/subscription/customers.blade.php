...
<section class="content--section" id="content--section">
    <div class="container">
        ...
        <div class="row row pt-2 align-items-center mb-5 d-none">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center justify-content-center mb-1 mt-1">
                                        ...
                                        <button class="btn btn--scheme btn--scheme-2 fs-12 px-4 mx-2 scale--self-05"
                                            ...
                                            data-bs-target='#prompt-customer'>Select</button>
            ...
            <div class="col-12 mt-cards plans-column" data-view="standard" data-instance="1">
                <div class="row pt-2 row align-items-center mb-4">
                    ...
                    <div class="col-12 text-center">
                        <button class="btn btn--scheme btn--scheme-2">
                            Half PM
                        </button>
                    ...
                    <div class="col-12 text-center mt-3 mb-2">
                        <button class="btn btn--scheme btn--scheme-1">
                            1100 - 1300
                        </button>
                    ...
                    <div class="col-12 ">
                        <div class="d-flex align-items-center justify-content-center flex-column">
                            <p class='mb-3'>
                                Select 3 Meals - 2 Sides - 1 Snack
                            </p>
                            ...
                            <div class='d-flex align-items-center'>
                                ...
                                <input type="text" class="form--input mx-2 text-center" value='0'
                            ...
                            {{-- ------------ --}}
                            <h4 class='mt-2 mb-1 mt-5'>AM Snack</h4>
                            <div class='d-flex align-items-center'>
                            ...
                            {{-- ------------ --}}
                            <h4 class='mt-2 mb-1'>PM Snack</h4>
                            <div class='d-flex align-items-center'>
                            ...
                            {{-- ------------ --}}
                            <h4 class='mt-2 mb-1 mt-3'>Drink</h4>
                            <div class='d-flex align-items-center'>
                    ...
                    {{-- loop - plans --}}
                    @foreach ($plans as $plan)
                    <div class="col-4 col-xl-3 col-xxl-3 d-none">
                        <div class="overview--card client-version scale--self-05 mb-floating">
                            <div class="row">
    ...
    {{-- modals --}}
    <livewire:subscription.customers.components.customers-prompt-customer />

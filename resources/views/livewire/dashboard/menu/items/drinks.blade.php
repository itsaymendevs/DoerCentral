                        ...
                        <div class="row">
                           ...
                           <div class="col-12 text-center position-relative">
                              <img class="client--card-logo"
                                 src="{{ asset('storage/menu/drinks/' . $drink->imageFile) }}" />
                           </div>
                           ...
                           <div class="col-12">
                              <div class="tabs--wrap">
                                 ...
                                 <ul class="nav nav-tabs inner for-sizes" role="tablist">
                                    ...
                                    @foreach ($drink->sizes as $drinkSize)
                                       <li class="nav-item" role="presentation">
                                          <a class="nav-link " data-bs-toggle="tab" href="#tab-1-{{ $drink->id }}"
                                             role="tab">{{ $drinkSize->size->name }}</a>
                                       </li>
                                    @endforeach
                                    {{-- end loop --}}
                                 ...
                                 <div class="tab-content">
                                    ...
                                    {{-- loop - sizes --}}
                                    @foreach ($drink->sizes as $drinkSize)
                                       <div class="tab-pane  no--card py-0 px-3" id="tab-1-{{ $drink->id }}"
                                          role="tabpanel">
                                          <div class="row">

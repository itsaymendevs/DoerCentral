   ...
   <div class="container">
      ...
      <form wire:submit='update' class="row mt-5 mb-5 align-items-center">
         ...
         <div class="col-5 mb-4">
            <label class="col-form-label upload--wrap mb-2" data-bs-toggle="tooltip" data-bss-tooltip=""
               ...
               <img id="blog--preview-1" wire:ignore.self class="inventory--image-frame"
                  src="{{ url('assets/img/placeholder.png') }}" width="512" height="250" style="aspect-ratio: 2/1" />
            </label>
         </div>
         ...
         <div class="col-4 mb-4">
            <label class="col-form-label upload--wrap mb-2" data-bs-toggle="tooltip" data-bss-tooltip=""
               ...
               <img id="blog--preview-2" wire:ignore.self class="inventory--image-frame"
                  src="{{ url('assets/img/placeholder.png') }}" width="512" height="250" />
            </label>
         </div>
         ...
         <div class="col-3">
            ...
            <div class="form-check form-switch mb-3 mealType--checkbox d-flex justify-content-center">
               ...
               {{-- input --}}
               <input class="form-check-input pointer" id="tags-checkbox" type="checkbox" wire:model='instance.showTags'
         ...
         <div class="col-12">
            <div class="row align-items-center">
               ...
               <div class="col-12 text-center d-flex justify-content-center align-items-end">
                  <button wire:loading.attr='disabled' wire:target='instance.imageFile, instance.headerImageFile, store'
      ...
      <div class="row mt-5 mb-5">
                        ...
                        <td>
                           <div class="d-flex align-items-center justify-content-center">
                              ...
                              <button type='button' class="btn btn--raw-icon inline edit scale--3"
                                 ...
                                 <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 16 16" class="bi bi-pencil-fill">
                                    <path
                              ...
                              <button wire:click='remove({{ $section->id }})' wire:loading.attr='disabled'
                                 class="btn btn--raw-icon inline remove scale--3" type="button" wire:target='remove'>
                                 <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
         ...
         <div class="col-3 text-center">
            <button class="btn btn--scheme btn--scheme-2 px-3 scalemix--3 py-2 d-inline-flex align-items-center mt-2"

...
<div>
   ...
   <div class="row align-items-start pt-2 mb-5 pb-4">
      ...
      <div class="col-6">
         <div class="row justify-content-center align-items-end">
            ...
            <div class="col-10 mt-5">
                     ...
                     <div class="btn-group submenu--group for-builder" role="group">
                        ...
                        @foreach ($meal->sizes as $mealSize)
                           <button class="btn fs-13 btn--switch-regular" data-instance='mealSizes'
                              data-view='size-{{ $mealSize->size->id }}'
                              type="button">{{ $mealSize->size->name }}</button>
                        @endforeach
                        {{-- end loop --}}
               ...
               @foreach ($meal->sizes as $mealSize)
                  <div class="row" data-instance='mealSizes' data-view='size-{{ $mealSize->size->id }}'>
                     ...
                     <div class="col text-end">
                        <div class="overview--box shrink--self macros-version">
                           ...
                           <p class="truncate-text-1l">
                              <input class="form-control form--input form--table-input-xs text-center readonly"
                                 type="number" value="{{ $mealSize->size->calories }}" readonly="" step="0.01" />
                           </p>
                        </div>
                     </div>
                     ...
                     <div class="col text-end">
                        <div class="overview--box shrink--self macros-version">
                           ...
                           <p class="truncate-text-1l">
                              <input class="form-control form--input form--table-input-xs text-center readonly"
                                 type="number" value="{{ $mealSize->size->proteins }}" readonly="" step="0.01" />
                           </p>
                        </div>
                     </div>
                     ...
                     <div class="col text-end">
                        <div class="overview--box shrink--self macros-version">
                           ...
                           <p class="truncate-text-1l">
                              <input class="form-control form--input form--table-input-xs text-center readonly"
                                 type="number" value="{{ $mealSize->size->carbs }}" readonly="" step="0.01" />
                           </p>
                        </div>
                     </div>
                     ...
                     <div class="col text-end">
                        <div class="overview--box shrink--self macros-version">
                           ...
                           <p class="truncate-text-1l">
                              <input class="form-control form--input form--table-input-xs text-center readonly"
                                 type="number" value="{{ $mealSize->size->fats }}" readonly="" step="0.01" />
                           </p>
                        </div>
                     </div>
      ...
      <div class="col-3">
         ...
         <div class="select--single-wrapper mb-4 mx-auto">
            <select class="form-select form--select2" id='container-select-1' data-instance='instance.containerId'>
               <option value=""></option>
         ...
         {{-- containerPreview --}}
         <div>
            <img class="w-100 of-contain" src="{{ asset('assets/img/Containers/3.png') }}" style="height: 170px" />
         </div>
      </div>
      {{-- endCol --}}
               ...
               <tbody>
                  <tr>
                     ...
                     <td class="fw-bold" colspan="2">
                        <input class="form-control form--input form--table-input-sm" type="number" value="250" />
                     </td>
                     <td colspan="2">
                        <input class="form-control form--input form--table-input-sm" type="number" value="30" />
                     </td>
                     <td class="scale--3" colspan="2">
                        <input class="form-control form--input form--table-input-sm" type="number" value="208" />
                     </td>
                     <td class="scale--3" colspan="2">
                        <input class="form-control form--input form--table-input-sm" type="number" value="13" />
                     </td>
                  ...
                  <tr>
                     ...
                     <td class="fw-bold">
                        <input class="form-control form--input form--table-input-xxs px-1" type="text"
                           value="250" />
                     </td>
                     <td class="fw-bold">
                     ...
                     <td class="fw-bold">
                        <input class="form-control form--input form--table-input-xxs px-1" type="number"
                           value="13" />
                     </td>
                     <td class="fw-bold">
                        <input class="form-control form--input form--table-input-xxs px-1 readonly" type="number"
                           value="250" readonly="" />
                     </td>
                     <td class="fw-bold">
                        <input class="form-control form--input form--table-input-xxs px-1 readonly" type="number"
                     ...
                     <td class="fw-bold">
                        <input class="form-control form--input form--table-input-sm px-2" type="text" />
                     </td>
                     <td class="fw-bold" data-bs-toggle="tooltip" data-bss-tooltip="" title="Removable From Meal">
                        <div class="form-check form-switch mealType--checkbox justify-content-center">
                           <input class="form-check-input pointer" id="formCheck-4" type="checkbox"
                              checked="" /><label class="form-check-label d-none"
                              for="formCheck-4">Dinner</label>
                        </div>
                     </td>
                     <td class="fw-bold">
                        <div class="d-flex align-items-center justify-content-center">
                           <button class="btn btn--raw-icon inline remove scale--3 px-0" type="button">
   ...
   <div class="row align-items-center">
      <div class="col-9">
         <label class="form-label form--label">Instruction</label><input class="form-control form--input mb-4"
            type="text" />
      </div>

      ...
      <div class="row align-items-center mt-5">
         ...
         <div class="col-4 text-center">
            ...
            <button wire:click='export' wire:loading.class='disabled'
               ...
               type="button">
               <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16"
                  class="bi bi-file-text fs-6 me-2">
                  <path
                     ...
                     <tr key='production-row-{{ $scheduleMealsByMeal?->first()?->id }}'>
                        ...
                        <td class="fw-bold text-start">
                           <span class="d-block fw-normal">{{
                              ...
                              {{-- :: view instructions --}}
                              <button class="btn btn--raw-icon fs-14 text-warning d-inline-block scale--3 w-auto ms-1"
                                 ...
                                 <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 16 16" class="bi bi-eye fs-6" style="fill: var(--bs-warning)">
                                    <path
                        ...
                        <td class="text-start">
                           ...
                           <div class="kitchen--size-box mb-2 btn--remove" style="border-color:var(--bs-danger)">
                              <a href="#!" data-bs-toggle='modal' data-bs-target='#view-excludes'
                                 class='init-link w-100' wire:click="viewExcludes({{ $scheduleMealsByMeal }})">
                           ...
                           <div class="kitchen--size-box mb-2 btn--remove" style="border-color:var(--bs-danger)">
                              <a href="#!" data-bs-toggle='modal' data-bs-target='#view-remarks' class='init-link w-100'
                        ...
                        <td class="text-start">
                           ...
                           <img class='w-100 of-contain' style="height: 130px"
                              src="{{ url('storage/menu/meals/' . ($scheduleMealsByMeal->first()?->meal?->imageFile ?? $defaultPlate)) }}">

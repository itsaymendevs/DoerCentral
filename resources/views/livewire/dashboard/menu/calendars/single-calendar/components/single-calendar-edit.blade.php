...
<form wire:submit='update' id='schedule--form'>
               ...
               <div>
                  ...
                  <ul class="nav nav-tabs inner" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                        <a class="nav-link @if ($mealTypes->first()->id == $mealType->id) active @endif" role="tab"
                           data-bs-toggle="tab" href="#tab-type-{{ $mealType->id }}" wire:ignore.self>{{ $mealType->name
                           }}</a>
                     </li>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-12 text-center position-relative">
                                       <img class="client--card-logo"
                                          src="{{ url('storage/menu/meals/' . $meal->imageFile) }}" />
                                    </div>
                                       ...
                                       <div class="d-flex align-items-center justify-content-center">
                                          <div
                                             ...
                                             <input class="form-check-input pointer"
                                                id="formCheck-{{ $mealType->id }}-{{ $meal->id }}" type="checkbox" @if
                                                ($scheduleMeal) checked @endif
                                    ...
                                    <div class="col-6">
                                       <div class="d-flex align-items-center justify-content-center">
                                          <div
                                             ...
                                             {{-- input --}}
                                             <input class="form-check-input pointer default--radio" type="radio"
                                                id="formRadio-{{ $mealType->id }}-{{ $meal->id }}"
                                                name="{{ $mealType->shortName }}-default" wire:loading.attr='disabled'
                                    ...
                                    <div class="col-4">
                                       <div class="d-flex align-items-center justify-content-center">
                                          <div
                                             ...
                                             {{-- label --}}
                                             <label class="form-check-label fs-12 mx-0 mt-2 pointer text-center"
   ...
   <script src="{{ url('assets/js/menu-calendar.js') }}"></script>

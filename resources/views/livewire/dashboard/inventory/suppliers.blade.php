        ...
        <div class="row mb-4">
            ...
            <div class="col-3">
                <button class="btn btn--scheme btn--scheme-2 px-3 scalemix--3 py-2 d-inline-flex align-items-center"
                    data-bs-target="#new-supplier" data-bs-toggle="modal" type="button">
            ...
            <div class="col-6 text-center">
                <input wire:model.live='searchSupplier' class="form-control form--input main-version mx-auto"
                    type="search" placeholder="Search for Supplier" />
            </div>
                    ...
                    <table class="table table-bordered" id="memoir--table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- address --}}
                                <td class="scale--3">{{ $supplier->address }}</td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <button class="btn btn--raw-icon inline view scale--3" data-bs-toggle="tooltip"
                                            ...
                                            title="{{ implode('<br />', $supplier->categoriesInArray()) }}">
                                ...
                                <td class="scale--3">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <button class="btn btn--raw-icon inline view scale--3"
                                            data-bs-target="#supplier-ingredients" data-bs-toggle="modal" type="button"
                                            wire:click='manageIngredients({{ $supplier->id }})'>
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <button class="btn btn--raw-icon inline edit scale--3" data-bs-toggle="modal"
                                            wire:click='edit({{ $supplier->id }})' data-bs-target="#edit-supplier"
                                            type="button">
                                        ...
                                        <button class="btn btn--raw-icon inline remove scale--3" type="button"
                                            wire:click='remove({{ $supplier->id }})' wire:loading.attr='disabled'>

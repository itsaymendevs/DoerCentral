            ...
            <div class="col-7">
                <div class="row justify-content-center">
                    ...
                    <div class="col-5">
                        ...
                        <input type="number" step='0.1' class="form--input mb-4" required wire:model='instance.width' />
                    </div>
                    ...
                    <div class="col-10">
                        ...
                        <div class="input--with-label mb-3">
                            ...
                            <input type="color" class="form--input py-1 pointer" required
                                wire:model='instance.backgroundColor' />
                        </div>
                        ...
                        <div class="input--with-label mb-3">
                            ...
                            <input type="color" class="form--input py-1 pointer" required
                                wire:model='instance.labelBackgroundColor' />
                        </div>

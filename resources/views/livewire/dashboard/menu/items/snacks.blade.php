      ...
      <div class="row">
         ...
         <div class="col-2 text-start">
            <h3 class="fw-bold text-white scale--self-05 d-inline-block badge--scheme-2 px-3 rounded-1 mb-0 py-1"
               data-bs-toggle="tooltip" data-bss-tooltip="" title="Number of Snacks">
               {{ $snacks->total() }}
            </h3>
         </div>
      ...
      <div class="row row pt-2 align-items-center mb-5">
         ...
         <div class="col-12 mt-zone-cards plans-column" data-view="standard" data-instance="1">
            <div class="row pt-2 row align-items-center mb-4">
               ...
               <div class="col-4 col-xl-3 col-xxl-3" key='single-snack-{{ $snack->id }}'>
                  <div class="overview--card client-version scale--self-05 mb-floating">
                     <div class="row">
                        ...
                        <div class="col-12 text-center position-relative">
                           <div class="position-relative">
                              ...
                              <img class="client--card-logo"
                                 src="{{ url('storage/menu/meals/' . ($snack->imageFile ?? $defaultPlate)) }}" />
                              ...
                              <button class="btn client--floating-button" type="button" data-bs-target="#menu-list"
                                 data-bs-toggle="modal" wire:click="editMenuList('{{ $snack->id }}')">
                        ...
                        <div class="col-12">
                           ...
                           {{-- name --}}
                           <h6 class="text-center fw-bold mt-3 mb-2 truncate-text-2l height-2l">{{ $snack->name
                              }}</h6>
                           ...
                           <p class="text-center fs-13 fw-bold text-danger mb-0">
                              <button
                                 ...
                                 type="button">{{ $snack->partType ?? 'Not Specified' }}</button>
                           </p>
                        </div>
                        ...
                        $initSnackSizeId = $snack?->sizes?->first()?->id ?? null;
                        ...
                        <div class="col-12">
                           <div class="tabs--wrap">
                              ...
                              <ul class="nav nav-tabs inner for-sizes" role="tablist">
                                 ...
                                 {{-- loop - sizes --}}
                                 @foreach ($snack->sizes as $snackSize)
                                 <li class="nav-item" role="presentation">
                                    <a class="nav-link @if ($initSnackSizeId == $snackSize->id) active @endif"
                                       data-bs-toggle="tab" href="#tab-1-{{ $snackSize->id }}" role="tab">
                                       {{ $snackSize->size->shortName }}
                                    </a>
                                 </li>
                                 @endforeach
                                 {{-- end loop --}}
                              ...
                              <div class="tab-content">
                                 ...
                                 @foreach ($snack->sizes as $snackSize)
                                 <div
                                    class="tab-pane no--card py-0 px-3 @if ($initSnackSizeId == $snackSize->id) active @endif"
                                    id="tab-1-{{ $snackSize->id }}" role="tabpanel">
                                    ...
                                    <div class="row">
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             ...
                                             <p class="fs-12">{{ $snackSize->afterCookCalories }}</p>
                                          </div>
                                       </div>
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             <h6 class="fs-12">P</h6>
                                             <p class="fs-12">{{ $snackSize->afterCookProteins }}</p>
                                          </div>
                                       </div>
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             <h6 class="fs-12">C</h6>
                                             <p class="fs-12">{{ $snackSize->afterCookCarbs }}</p>
                                          </div>
                                       </div>
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             <h6 class="fs-12">F</h6>
                                             <p class="fs-12">{{ $snackSize->afterCookFats }}</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-3">
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-1 scale--self-05 h-32 "
                                 ...
                                 title="{{ implode(' &#8226; ', $snack->partsInArray()) }}">
                              ...
                              <button class="btn btn--scheme btn--remove fs-12 px-2 mx-1 scale--self-05 h-32"
                                 wire:loading.attr='disabled' type="button" wire:click='remove({{ $snack->id }})'>

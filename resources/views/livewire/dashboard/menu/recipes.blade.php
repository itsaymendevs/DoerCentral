<section class="content--section" id="content--section">
                        ...
                        <div class="col-12">
                           <div class="tabs--wrap">
                              ...
                              <div class="tab-content">
                                 ...
                                 @foreach ($meal->sizes as $mealSize)
                                 <div
                                    class="tab-pane no--card py-0 px-3 @if ($meal->sizes->first()->id == $mealSize->id) active @endif"
   ...
   {{-- 1: menuList --}}
   <livewire:dashboard.menu.recipes.components.recipes-menu-list key='recipes-menu-list-modal' />

            ...
            <table class="table table-bordered" id="memoir--table">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     {{-- id --}}
                     <td class="fw-bold">SP-001</td>


                     {{-- name - phone --}}
                     <td class="fw-bold">Nature Veggies</td>
                     <td>55192012</td>


                     {{-- address --}}
                     <td class="scale--3">
                        Fake Address For Supplier
                     </td>
                     ...
                     <td class="scale--3">
                        <div class="d-flex align-items-center justify-content-center">
                           <button class="btn btn--raw-icon inline view scale--3" data-bs-target="#supplier-ingredients"
                     ...
                     <td>
                        <div class="d-flex align-items-center justify-content-center">
                           ...
                           <button class="btn btn--raw-icon inline edit scale--3" data-bs-toggle="modal"
                              data-bs-target="#edit-supplier" type="button">

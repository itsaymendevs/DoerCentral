...
class DeliveryZonesEdit extends Component
{
   ...
   public function remount($id)
   {
      ...
      // 1.2: setFilePreview
      $preview = url('storage/delivery/zones/' . $this->instance->imageFile);
   ...
   public function render()
   {
      ...
      return view('livewire.dashboard.delivery.delivery-zones.components.delivery-zones-edit', compact('cities'));

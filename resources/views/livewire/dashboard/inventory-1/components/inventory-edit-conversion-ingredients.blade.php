<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="edit-conversion-ingredients" wire:ignore.self>
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document" style="max-width: unset; width: 90%;">
        <div class="modal-content">
            <div class="modal-body py-0 px-0">
                ...
                <header class="modal--header px-4">
                    <h5 class="mb-0 fw-bold text-white">Conversion Ingredients</h5>
                                ...
                                <table class=" table table-bordered" id="memoir--table">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="th--md fs-11">{{ $cookingType->name }}</th>

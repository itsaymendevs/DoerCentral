<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="new-role" wire:ignore.self>
        ...
        <div class="modal-content">
            <div class="modal-body py-0 px-0">
                ...
                <header class="modal--header px-4">
                    <h5 class="mb-0 fw-bold text-white">New Department</h5>
                                                    ...
                                                    <td class="fw-bold">
                                                        <div
                                                            ...
                                                            <label class="form-check-label d-none"
                                                                for="formCheck-{{ $permission->id }}">Label</label>
                                                        </div>
                                                    </td>

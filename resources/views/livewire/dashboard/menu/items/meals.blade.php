      ...
      <div class="row">
         ...
         <div class="col-3">
            <input wire:model.live='searchMeal' class="form--input main-version mx-auto" type="search"
               style="width: 80% !important" placeholder="Search for Meal" />
         </div>
               ...
               <div class="col-4 col-xl-3 col-xxl-3" key='single-meal-{{ $meal->id }}'>
                  <div class="overview--card client-version scale--self-05 mb-floating">
                     <div class="row">
                        ...
                        <div class="col-12 text-center position-relative">
                           <div class="position-relative">
                              ...
                              <img class="client--card-logo"
                                 src="{{ url('storage/menu/meals/' . ($meal->imageFile ?? $defaultPlate)) }}" />
                              ...
                              <button class="btn client--floating-button" type="button" data-bs-target="#menu-list"
                                 data-bs-toggle="modal" wire:click="editMenuList('{{ $meal->id }}')">
                        ...
                        <div class="col-12">
                           ...
                           <p class="text-center fs-13 fw-bold text-danger mb-0">
                              <button
                                 ...
                                 type="button">{{ $meal->partType ?? 'Not Specified' }}</button>
                           </p>
                        </div>
                        ...
                        $initMealSizeId = $meal?->sizes?->first()?->id ?? null;
                           ...
                           <div class="tabs--wrap">
                              ...
                              <ul class="nav nav-tabs inner for-sizes" role="tablist">
                                 ...
                                 <li class="nav-item" role="presentation">
                                    <a class="nav-link @if ($initMealSizeId == $mealSize->id) active @endif"
                                       data-bs-toggle="tab" href="#tab-1-{{ $mealSize->id }}" role="tab">
                              ...
                              <div class="tab-content">
                                 ...
                                 @foreach ($meal->sizes as $mealSize)
                                 <div
                                    class="tab-pane no--card py-0 px-3 @if ($initMealSizeId == $mealSize->id) active @endif"
                                    id="tab-1-{{ $mealSize->id }}" role="tabpanel">
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-3">
                              ...
                              <button class="btn btn--scheme btn--remove fs-12 px-2 mx-1 scale--self-05 h-32"
                                 wire:loading.attr='disabled' type="button" wire:click='remove({{ $meal->id }})'>

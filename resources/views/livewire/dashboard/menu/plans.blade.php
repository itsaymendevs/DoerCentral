                  ...
                  <div class="overview--card client-version scale--self-05 mb-floating">
                     <div class="row">
                        ...
                        <div class="col-12 text-center position-relative">
                           <img class="client--card-logo" src="{{ url('storage/menu/plans/' . $plan->imageFile) }}" />
                        </div>
               ...
               <div class="col" data-aos="fade-right" data-aos-duration="1000">
                  ...
                  <div class="row align-items-center">
                        ...
                        <div class="item--box mb-3">
                           <h4 class="fw-semibold d-flex align-items-center">
                              <svg class="bi bi-chevron-compact-right me-2 fs-13"
                                 style="fill: var(--color-theme-secondary)" xmlns="http://www.w3.org/2000/svg"
                     ...
                     <div class="col-6 mt-3">
                        <label class="col-form-label fs-6 text-center form--label py-0 justify-content-center"><svg
                              class="bi bi-brush fs-5 me-2" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                              fill="currentColor" viewBox="0 0 16 16">
                              <path
                     ...
                     <div class="col-4 mt-3">
                        <input class="form--input" type="color" style="height: 25px; padding: 0px; cursor: pointer" />
                     </div>
               ...
               <div class="col-3">
                  <div class="plan--switch-card">
                     <a class="init-link d-block" href="#">
                        <img class="w-100 of-contain" src="{{ url('storage/plans/' . $plan->imageFile) }}"
                           style="height: 215px" />

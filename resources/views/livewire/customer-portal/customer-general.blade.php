      ...
      <form wire:submit='update' class="row align-items-start justify-content-center pt-3 mb-5">
                  ...
                  <div class="row">
                     ...
                     <div class="col-12">
                        <div class="input--with-label journey mb-4">
                           ...
                           <input class="form--input readonly" readonly type="date" wire:model='instance.birthDate' />
                        </div>
                     </div>
                     ...
                     <div class="col-12 col-sm-6">
                        <div class="input--with-label journey mb-4">
                           ...
                           <input type="text" class="form--input readonly" readonly required wire:model='instance.phone'
                     ...
                     <div class="col-12 d-block d-xl-none mt-3 mb-5">
                        <button
                           ...
                           style="border: 1px solid var(--color-theme-alternative)" wire:loading.attr='disabled'
                           wire:target='update'>
                           Update Profile
                        </button>
                     </div>
         ...
         <div class="col-11 col-xl-2 text-center order-first order-xl-2 mb-md-5 mb-xl-0 mt-3">
            ...
            <img class="w-100 of-contain d-none d-md-none"
               src='{{ url("assets/img/Customers/{$customer->gender}.png") }}' style="height: 250px" />
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-12 col-sm-6 mb-3 mb-xl-0">
                           ...
                           <img class="of-cover w-100 rounded-1"
                              src="{{ url('storage/menu/plans/' . $latestSubscription->plan->imageFile) }}"
                              style="height: 200px" />

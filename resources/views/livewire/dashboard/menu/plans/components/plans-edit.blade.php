                                ...
                                <div class="col-4">
                                    ...
                                    <div class="d-flex mb-3">
                                        <label class="form-label upload--wrap w-100" data-bs-toggle="tooltip"
                                            data-bss-tooltip="" for="plan--file-7" title="Click To Upload">


                                            {{-- input --}}
                                            <input class="form-control d-none file--input" id="plan--file-7"
                                                data-preview="plan--preview-7" type="file"
                                                wire:model='instance.imageFile' />

                                            {{-- preview --}}
                                            <img class="inventory--image-frame" style="height: 293px;"
                                                id="plan--preview-7" src="{{ asset('assets/img/placeholder.png') }}"
                                                wire:ignore />
                                    ...
                                    <div class='d-flex'>
                                        <label class="form-label upload--wrap w-100" data-bs-toggle="tooltip"
                                            data-bss-tooltip="" for="plan--file-8" title="Click To Upload">


                                            {{-- input --}}
                                            <input class="form-control d-none file--input" id="plan--file-8"
                                                data-preview="plan--preview-8" type="file"
                                            ...
                                            {{-- preview --}}
                                            <img class="inventory--image-frame" style="height: 293px;"
                                                id="plan--preview-8" src="{{ asset('assets/img/placeholder.png') }}"
                                                wire:ignore />
                                ...
                                <div class="col-8">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control form--input form--textarea mb-4"
                                                style="height: 172px" wire:model='instance.longDesc'
                                                required></textarea>
                                        </div>
                                ...
                                <div class='col-6 mb-4'>
                                    <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                        ...
                                        <input class="form-control d-none file--input" id="plan--file-9"
                                            data-preview="plan--preview-9" type="file"
                                ...
                                <div class='col-6 mb-4'>
                                    <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                        ...
                                        <input class="form-control d-none file--input" id="plan--file-10"
                                            data-preview="plan--preview-10" type="file"
                                ...
                                <div class='col-6'>
                                    <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                        ...
                                        <input class="form-control d-none file--input" id="plan--file-12"
                                            data-preview="plan--preview-12" type="file"
                                ...
                                <div class='col-6'>
                                    <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                        ...
                                        <input class="form-control d-none file--input" id="plan--file-11"
                                            data-preview="plan--preview-11" type="file"

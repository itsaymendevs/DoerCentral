                  ...
                  <form class="col-12" wire:submit='store'>
                     <div class="row align-items-center">
                        ...
                        <div class="col-4">
                           ...
                           <input wire:model='instance.days' class="form-control form--input mb-4" type="number"
                              step='1' required>
                        </div>
                        ...
                        <div class="col-4">
                           ...
                           <input wire:model='instance.discount' class="form-control form--input mb-4" type="number"
                              step='0.01' required>
                        </div>

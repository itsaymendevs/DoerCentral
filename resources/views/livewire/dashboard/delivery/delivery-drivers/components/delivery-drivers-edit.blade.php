                    ...
                    <div class="row align-items-start pt-2 mb-4">
                        ...
                        <div class="col-4">
                            ...
                            <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                ...
                                {{-- caption --}}
                                <span class="upload--caption badge">Driver's Profile</span>
                        ...
                        <div class="col-4">
                            ...
                            <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                ...
                                <input class="form-control d-none file--input" id="license--file-4"
                                    data-preview="license--preview-4" type="file"
                                    wire:model='instance.licenseRearFile' />
                        ...
                        {{-- hr --}}
                        <div class="col-12 mt-4 pt-2 mb-2">
                            <div class="d-flex align-items-center justify-content-between mb-1">
                                <hr style="width: 70%">
                                <label class="form-label form--label
                                px-3 w-50 justify-content-center mb-0">Vehicle Information</label>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            {{-- plate --}}
                            <input class="form-control form--input mb-4" type="text" wire:model='instance.plate'
                        ...
                        <div class="col-6">
                            ...
                            {{-- input --}}
                            <input class="form-control form--input mb-4 invisible" type="text" />
                            ...
                            <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                ...
                                <input class="form-control d-none file--input" id="ownership--file-2"
                                    data-preview="ownership--preview-2" type="file"
                        ...
                        <div class="col-12 text-end mt-4">
                            <button
                                ...
                                wire:target='update, instance.imageFile, instance.licenseFile'

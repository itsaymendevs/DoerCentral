<section id="content--section" class="content--section">
   <div class="container">
      ...
      {{-- :: SubMenu --}}
      <livewire:dashboard.stock.components.sub-menu title='Label Builder' key='stock-submenu' />
            ...
            <div class="row justify-content-center">
               ...
               <div class="col-12 text-center mb-4">
                  ...
                  <button
                     ...
                     wire:target='update, instance.imageFile, instance.footerImageFile'>Update</button>
               </div>
               ...
               <div class="col-12">
                  <div class="sticker--label-layout sticky--div mb-4"
                     style="
                            background-image: url({{ url('storage/kitchen/containers/' . $containers?->first()?->imageFile) }});">
                     ...
                     <div class="sticker--label mx-auto position-relative
                        ...
                        {{-- 1.5: top --}}
                        <div class='sticker--label-header d-flex justify-content-around align-items-center' style="padding-left: {{ $instance->paddingLeft  ?? 0 }}mm;
                        ...
                        {{-- 2: middle --}}
                        <div class='sticker--label-content d-flex justify-content-around align-items-center ' style="padding-left: {{ $instance->paddingLeft  ?? 0 }}mm;
                                        padding-right: {{ $instance->paddingRight  ?? 0 }}mm;">
                        ...
                        <div class='sticker--label-footer d-flex flex-column'>
                           ...
                           <img id='footer--preview-2' class='of-contain w-100 h-100'
                              src=" {{ url('assets/img/Labels/placeholder.png') }}" wire:ignore.self>
               ...
               <div class="col-3">
                  ...
                  <input type="number" step='0.1' class="form--input mb-4" required wire:model.live='instance.width' />
               </div>
               ...
               <div class="col-2">
                  ...
                  <input type="number" step='0.1' class="form--input mb-4" required wire:model.live='instance.height' />
               </div>
               ...
               <div class="col-3">
                  ...
                  <input type="number" step='0.1' class="form--input mb-4" wire:model.live='instance.macroRadius'
                     required />
               </div>
               ...
               <div class="col-3">
                  ...
                  <input type="number" step='0.1' class="form--input mb-4" wire:model.live='instance.paddingLeft' />
               </div>
               ...
               <div class="col-2">
                  ...
                  <input type="number" step='0.1' class="form--input mb-4" wire:model.live='instance.paddingRight' />
               </div>
               ...
               <div class="col-2">
                  ...
                  <input type="number" step='0.1' class="form--input mb-4" wire:model.live='instance.paddingTop' />
               </div>
               ...
               <div class="col-3">
                  ...
                  <input type="number" step='0.1' class="form--input mb-4" wire:model.live='instance.paddingBottom' />
               </div>
         ...
         <div class="col-5">
            <div class="row">
               ...
               <div class="col-5">
                  ...
                  <input type="number" step='0.01' class="form--input mb-4" required wire:model='instance.charge' />
               </div>
                  ...
                  <div>
                     ...
                     <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                        ...
                        <input type="file" id="poster--file-1" class="d-none file--input"
                           data-preview="poster--preview-1" wire:model='instance.imageFile' />


                        {{-- preview --}}
                        <img id="poster--preview-1" class="inventory--image-frame"
                           src="{{ url('assets/img/placeholder.png') }}" style="height: 180px" wire:ignore />
                     ...
                     <div class="col-6">
                        <div class="form-check form-switch mb-3 mealType--checkbox">
                           <input class="form-check-input pointer sm" type="checkbox" id="formCheck-0"
                              @if($instance->isVertical) checked @endif
                     ...
                     <div class="col-6">
                        <div class="form-check form-switch mb-3 mealType--checkbox">
                           <input class="form-check-input pointer sm" type="checkbox" id="formCheck-1"
                              @if($instance->showCustomerName) checked @endif
                     ...
                     <div class="col-6">
                        <div class="form-check form-switch mb-3 mealType--checkbox">
                           <input class="form-check-input pointer sm" type="checkbox" id="formCheck-2"
                              @if($instance->showMealName) checked @endif
                     ...
                     <div class="col-6">
                        <div class="form-check form-switch mb-3 mealType--checkbox">
                           <input class="form-check-input pointer sm" type="checkbox" id="formCheck-3"
                              @if($instance->showProductionDate) checked @endif
                     ...
                     <div class="col-6">
                        <div class="form-check form-switch mb-3 mealType--checkbox">
                           <input class="form-check-input pointer sm" type="checkbox" id="formCheck-4"
                              @if($instance->showExpiryDate) checked @endif
                     ...
                     <div class="col-6">
                        <div class="form-check form-switch mb-3 mealType--checkbox">
                           <input class="form-check-input pointer sm" type="checkbox" id="formCheck-5"
                              @if($instance->showMealMacros) checked @endif
                     ...
                     <div class="col-6">
                        <div class="form-check form-switch mb-3 mealType--checkbox">
                           <input class="form-check-input pointer sm" type="checkbox" id="formCheck-7"
                              @if($instance->showFooterImageFile) checked @endif
   ...
   {{-- 1: labelBuilder --}}
   <script src="{{ url('assets/js/label-builder.js') }}"></script>

<section class="content--section" id="content--section">
   <div class="container">
      ...
      <div class="row">
         ...
         {{-- search --}}
         <div class="col-3">
            <input class="form--input main-version mx-auto" type="search" style="width: 80% !important"
               placeholder="Search for Sides" />
         </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-12 text-center position-relative">
                              <img class="client--card-logo"
                                 src="{{ asset('storage/menu/sides/' . $side->imageFile) }}" />
                           </div>
                           ...
                           <div class="col-12">
                              ...
                              {{-- name --}}
                              <h6 class="text-center fw-bold mt-3 mb-2 truncate-text-2l height-2l"></h6>

<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="new-item" wire:ignore.self>
      ...
      <div class="modal-content">
         <div class="modal-body py-0 px-0">
            ...
            <header class="modal--header px-4">
               <h5 class="mb-0 fw-bold text-white">New Item</h5>
            ...
            <form wire:submit='store' class="px-4">
               <div class="row align-items-center row pt-2 mb-4">
                  ...
                  {{-- description --}}
                  <div class="col-12">
                     <label class="form-label form--label">Information</label>
                  ...
                  <div class="col-12">
                     <div>
                        ...
                        <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                           title="Click To Upload" for="item--file-1">


                           {{-- input --}}
                           <input class="form-control d-none file--input" type="file" id="item--file-1"
                              data-preview="item--preview-1" required wire:model='instance.imageFile' />



                           {{-- imageFile --}}
                           <img id="item--preview-1" class="inventory--image-frame"

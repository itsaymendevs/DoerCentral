...
class IngredientsEdit extends Component
{
    ...
    public function update()
    {
        ...
        // 1.2: makeRequest
        $response = $this->makeRequest('central/dashboard/inventory/ingredients/update', $this->instance);
    ...
    public function render()
    {
        ...
        return view('livewire.central.dashboard.inventory.ingredients.components.ingredients-edit', compact('units'));

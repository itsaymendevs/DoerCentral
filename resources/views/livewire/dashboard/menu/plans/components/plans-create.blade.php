<div class="modal fade modal--shadow" id="new-plan" role="dialog" tabindex="-1" wire:ignore>
                     ...
                     <div>
                        <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                           ...
                           <input class="form-control d-none file--input" id="plan--file-1"
                              data-preview="plan--preview-1" type="file" required wire:model='instance.imageFile' />
                  ...
                  <div class="col-8">
                     <div class="row">
                        ...
                        <div class="col-12">
                           ...
                           <textarea class="form-control form--input form--textarea mb-4" wire:model='instance.longDesc' required></textarea>
                        </div>
                     </div>
                  </div>
                  {{-- end rightCol --}}

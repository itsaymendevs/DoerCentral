   ...
   <div class="row row pt-2 align-items-center mb-4">
      ...
      <div class="col-6 text-center">
         <input class="form-control form--input main-version mx-auto" type="search"
            placeholder="Search for PO. / Reference" />
      </div>
            ...
            <table class="table table-bordered" id="memoir--table">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="fw-bold">PU-001</td>
                     <td class="fw-bold">Nature Veggies</td>
                     <td>18-989 / RF-1928</td>
                     ...
                     <td class="scale--3">
                        <div class="d-flex align-items-center justify-content-center">
                           <button class="btn btn--raw-icon inline view scale--3" data-bs-target="#view-purchase"
                     ...
                     {{-- pricing --}}
                     <td class="fw-bold">
                        <span class="fw-bold fs-6">2,500</span>
                     </td>
                     ...
                     {{-- confirmPurchase --}}
                     <td class="fw-bold">
                        <span class="badge fs-11 badge--warning pointer scale--self-05">Confirm?</span>
                     </td>

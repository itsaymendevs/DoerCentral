...
<tr>
    ...
    {{-- 1: ID - name - caloriesRange - desc --}}
    <td>
        <input class="form-control form--input form--table-input-md" type="text" wire:model='instance.name'
            wire:change="update()" wire:loading.attr='readonly' wire:taget='update, remove' required />
    </td>

<section id="content--section" class="content--section">
    <div class="container">
        ...
        <div class="row align-items-end mb-submenu">
            <div class="col-12 mt-4" data-aos="fade" data-aos-duration="600" data-aos-once="true" wire:ignore.self>
            ...
            {{-- ** GET ADDRESS --}}
            @php $customerAddress = $delivery->customer->addressByDay($delivery->deliveryDate); @endphp

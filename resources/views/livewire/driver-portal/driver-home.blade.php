<section id="content--section" class="content--section">
   <div class="container">
      ...
      <div class="row align-items-end mb-submenu mb-0">
         ...
         {{-- shiftType --}}
         <div class="col-12 text-center" data-aos="fade" data-aos-duration="600" data-aos-once="true" wire:ignore.self>
            ...
            <h6 class="fw-semibold mb-3 d-flex align-items-center justify-content-center">
               <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16"
                  class="bi bi-sun-fill fs-3 me-2 rotateInfinite" style="fill: #dba400">
                  <path
            ...
            <h6 class="fw-semibold mb-3 d-flex align-items-center justify-content-center">
               <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16"
                  class="bi bi-moon-fill fs-3 me-2 scaleInfinite" style="fill: #dba400">
                  <path
         ...
         {{-- 1: total --}}
         <div class="col-4 text-end" data-aos="fade-left" data-aos-duration="600" data-aos-once="true" wire:ignore.self>
      ...
      <div class="row align-items-end mb-submenu pb-4" data-aos="fade" data-aos-duration="800" data-aos-once="true"
         ...
         <div class="col-12 mt-5 pb-3" key='single-delivery-{{ $delivery->id }}'>
            <div class="delivery--wrap position-relative" data-aos="fade" data-aos-duration="600" data-aos-once="true"
               wire:ignore.self>
               ...
               <div class="mt-4 d-flex align-items-center justify-content-between">
                  ...
                  <label for='capture--QR'
                     class="btn btn--scheme btn--scheme-outline-3 py-1 d-inline-flex align-items-center justify-content-center shrink--self fs-12 text-white d-none">Confirm
                     Picking</label>
         ...
         <div class="col-12 mb-5">
            <div class="profile--wrap" data-aos="fade" data-aos-duration="600" data-aos-once="true" wire:ignore.self>

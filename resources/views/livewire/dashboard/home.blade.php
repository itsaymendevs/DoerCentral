...
<section id="content--section" class="content--section">
               ...
               <div class="tab-content mt-2">
                  ...
                  <div class="tab-pane fade no--card" id="tab-11" role="tabpanel">
                     ...
                     <div class="row  dashboard--wrapper justify-content-center">
                        ...
                        <div class="col-2 text-end mb-4" key='home--total-checkout-{{ $key }}' data-aos="fade-up"
                           data-aos-duration="600" data-aos-delay="{{ $key * 100 }}" data-aos-once="true"
                           wire:ignore.self>
                           <div class="overview--box shrink--self">
                  ...
                  <div class="tab-pane fade no--card" id="tab-12" role="tabpanel">
                     ...
                     <div class="row  dashboard--wrapper justify-content-center">
                        ...
                        <div class="col-2 text-end mb-4" wire:ignore.self>
                           <div class="overview--box shrink--self">
                              <h6 class='fs-13'>Total</h6>
                              <p>{{ number_format($subscriptions->where('startDate', '<=', $globalCurrentDate)?->
                                    where('untilDate', '>=',
                     ...
                     <div class="row justify-content-center">
                        <div class="col-4">
                           ...
                           <input class="form-control form--input mb-4" type="date" min='{{ $globalCurrentDate }}'
                              wire:model.live='scheduleDate' wire:loading.attr='readonly' />
                              ...
                              <table class="table table-bordered" id="memoir--table">
                                 ...
                                 <tbody>
                                    ...
                                    <tr key='unassigned--customer-meals-{{ $commonCustomer }}'>
                                       ...
                                       {{-- action --}}
                                       <td>
                                          <button wire:click="manageUnassigned({{ $commonCustomer }})" type='button'
                           ...
                           <div class="table-responsive memoir--table w-100">
                              <table class="table table-bordered" id="memoir--table">
                                 ...
                                 <tbody>
                                    ...
                                    ?->where('untilDate', '<=', date('Y-m-d', strtotime('+3 days +4 hours'))) ?? []
                                    as $key=> $subscription) <tr key='expiring--customers-{{ $key }}'>
   ...
   {{-- clockjs --}}
   <script src="{{ url('assets/js/init-clock.js') }}"></script>
   ...
   {{-- initChartjs --}}
   <script src="{{ url('assets/js/init-chart.js') }}"></script>

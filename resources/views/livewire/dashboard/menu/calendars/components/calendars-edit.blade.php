<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="edit-calendar" wire:ignore.self>
      ...
      <div class="modal-content">
         <div class="modal-body py-0 px-0">
            ...
            <header class="modal--header px-4">
               <h5 class="mb-0 fw-bold text-white">Edit Calendar</h5>
            ...
            <form wire:submit='update' class="px-4">
               <div class="row row pt-2 mb-4">
                  ...
                  <div class="col-4">
                     <div>
                        ...
                        <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                           title="Click To Upload" for="calendar--file-2">


                           {{-- input --}}
                           <input class="form-control d-none file--input" type="file" id="calendar--file-2"
                              data-preview="calendar--preview-2" wire:model='instance.imageFile' />



                           {{-- image --}}
                           <img id="calendar--preview-2" class="inventory--image-frame"
                  ...
                  <div class="col-8">
                     <div class="row">
                        ...
                        <div class="col-12" wire:ignore>
                           ...
                           <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                              <select class="form-select form--modal-select form--modal-edit-calendar-select"
                                 data-modal='#edit-calendar' data-instance='instance.diets' data-trigger='true'
                                 id='diet-select-2' multiple>
                        ...
                        <div class="col-12" wire:ignore>
                           ...
                           <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                              <select class="form-select form--modal-select form--modal-edit-calendar-select"
                                 data-modal='#edit-calendar' data-instance='instance.plans' data-trigger='true'
                                 id='plan-select-2' multiple>
                  ...
                  <div class="col-12 text-end mt-3">
                     <button wire:loading.attr='disabled' wire:target='instance.imageFile, update'

        ...
        <div class="row align-items-end">
            ...
            <div class="col-3">
                <button class="btn btn--scheme btn--scheme-2 px-3 scalemix--3 py-2 d-inline-flex align-items-center"
                    data-bs-target="#new-zone" data-bs-toggle="modal" type="button"><svg
            ...
            <div class="col-3 text-end">
                <h3 class="fw-bold text-white scale--self-05 d-inline-block badge--scheme-2 px-3 rounded-1 mb-0 py-1"
                    data-bs-toggle="tooltip" data-bss-tooltip="" title="Number of Zones">{{ $zones->total() }}</h3>
            </div>
        ...
        <div class="row pt-2 align-items-center mb-4">
            ...
            <div class="col-12 mt-zone-cards">
                <div class="row pt-4 row align-items-center mb-3">
                        ...
                        <div class="overview--card client-version scale--self-05 mb-floating">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    {{-- zoneName --}}
                                    <h6 class="text-center fw-bold mt-3 mb-3
                                    truncate-text-1l fs-15">{{ $zone->name }}</h6>
                                    ...
                                    <p class="text-center fs-13 fw-bold text-danger pointer">
                                        <span class="fs-13 fw-semibold text-warning" data-bs-toggle="tooltip"
                                            data-bss-tooltip="" data-bs-placement="right" data-bs-html='true'
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center justify-content-center mb-1 mt-1">
                                        ...
                                        {{-- 1: edit --}}
                                        <button
                                            class="btn btn--scheme btn--scheme-2 h-32 fs-12 px-4 mx-2 scale--self-05"
                    ...
                    <div class="col-12">{{ $zones->links() }}</div>

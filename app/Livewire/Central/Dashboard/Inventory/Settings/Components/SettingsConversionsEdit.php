...
class SettingsConversionsEdit extends Component
{
    ...
    public function update()
    {
        ...
        // 1: makeRequest
        $response = $this->makeRequest('central/dashboard/inventory/settings/conversions/update', $this->instance);
    ...
    public function confirmRemove()
    {
        ...
        if ($this->removeId) {
            ...
            $response = $this->makeRequest('central/dashboard/inventory/settings/conversions/remove', $this->removeId);
    ...
    public function render()
    {
        ...
        return view('livewire.central.dashboard.inventory.settings.components.settings-conversions-edit');

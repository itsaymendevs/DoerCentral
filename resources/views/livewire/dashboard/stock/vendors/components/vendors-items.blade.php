{{-- vendorItems --}}
<div class="modal fade modal--shadow" id="vendor-items" role="dialog" tabindex="-1" wire:ignore.self>
        ...
        <div class="modal-content">
            <div class="modal-body py-0 px-0">
                ...
                <header class="modal--header px-4">
                    <h5 class="mb-0 fw-bold text-white">Vendor Items</h5>
                    ...
                    <div class="row align-items-center row pt-2 mb-4">
                        ...
                        <div class="col-3" wire:ignore>
                            ...
                            <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                                <select
                                    class="form-select form--modal-select form--modal-manage-vendor-select level--select level--one"
                                    data-level='items' data-id='1' data-modal='#vendor-items'
                        ...
                        <div class="col-5" wire:ignore>
                            ...
                            <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                                <select
                                    class="form-select form--modal-select form--modal-manage-vendor-select level--select level--two"
                                    data-id='1' data-modal='#vendor-items' data-instance='instance.itemId' required>
                                </select>
                            </div>
                        </div>
    ...
    {{-- select-handle --}}
    <script>
        $(".form--modal-manage-vendor-select").on("change", function(event) {
    ...
    {{-- levelSelectHandle --}}
    <script>
        $(".form--modal-manage-vendor-select.level--select").on("change", function(event) {

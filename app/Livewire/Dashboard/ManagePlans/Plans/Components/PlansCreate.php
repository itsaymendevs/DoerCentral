...
namespace App\Livewire\Dashboard\ManagePlans\Plans\Components;
...
class PlansCreate extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.manage-plans.plans.components.plans-create', compact('modules'));

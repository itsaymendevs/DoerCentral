<div class="row align-items-end pt-2">
   ...
   <div class="col-5 text-center">
      <img class="w-100 inventory--image-frame of-cover rounded-1" src="{{ url('assets/img/Diets/sizes-2.jpg') }}" />
   </div>
         ...
         <div class="col-8 text-end">
            ...
            <div class="row">
               ...
               <div class="col-6 text-end">
                  ...
                  <input wire:model='instance.shortName' class="form-control form--input mb-4" type="text" required />
               </div>
            ...
            <div class="row">
               ...
               <div class="col-6 text-end">
                  ...
                  <input class="form-control form--input " type="number" step='0.01' wire:model='instance.calories'
                     required />
               </div>
            </div>
            {{-- endRow --}}
      ...
      <div class="table-responsive memoir--table w-100">
         <table class="table table-bordered" id="memoir--table">
            ...
            <tbody>
               ...
               <livewire:dashboard.menu.settings.components.settings-view-size :id='$size->id' key='{{ $size->id }}' />

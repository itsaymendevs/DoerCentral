                        ...
                        <div class="col-12 text-center position-relative">
                           <div class="position-relative">
                              ...
                              <img class="client--card-logo"
                                 src="{{ url('storage/menu/meals/' . ($drink->imageFile ?? $defaultPlate)) }}" />
                              ...
                              <button class="btn client--floating-button" type="button" data-bs-target="#menu-list"
                                 data-bs-toggle="modal" wire:click="editMenuList('{{ $drink->id }}')">
                        ...
                        <div class="col-12">
                           <div class="tabs--wrap">
                              ...
                              <div class="tab-content">
                                 ...
                                 @foreach ($drink->sizes as $drinkSize)
                                 <div
                                    class="tab-pane  no--card py-0 px-3 @if ($initDrinkSizeId == $drinkSize->id) active @endif"
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-3">
                              ...
                              <button class="btn btn--scheme btn--remove fs-12 px-2 mx-1 scale--self-05 h-32"
                                 wire:loading.attr='disabled' type="button" wire:click='remove({{ $drink->id }})'>

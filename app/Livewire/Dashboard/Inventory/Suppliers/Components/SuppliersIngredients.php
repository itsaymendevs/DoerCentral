...
class SuppliersIngredients extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.inventory.suppliers.components.suppliers-ingredients', compact('ingredients', 'units', 'supplierIngredients'));

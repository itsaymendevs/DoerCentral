<section id="content--section" class="content--section">
    ...
    {{-- 1: create --}}
    <livewire:dashboard.manage-plans.plans.components.plans-create key='create-plan-modal' />


    {{-- 2: edit --}}
    <livewire:dashboard.manage-plans.plans.components.plans-edit key='edit-plan-modal' />

                     ...
                     <div class="row row pt-2 mb-4">
                        ...
                        <div class="col-5">
                           ...
                           <label class="form-label form--label">Shorten Until
                              <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                 class="bi bi-info-circle fs-5 ms-2" viewBox="0 0 16 16" data-bs-toggle="tooltip"
                                 data-bss-tooltip="" data-bs-placement="right"
                                 title='This date will be included in shortened days' style='fill: var(--bs-warning);'>
                        ...
                        <div class="col-12">
                           ...
                           <div class="w-100 mx-auto d-flex justify-content-around">
                              ...
                              <div class="form-check itemType--radio d-inline-flex mb-3">
                                 ...
                                 {{-- label --}}
                                 <label class="form-check-label fs-13 ms-2" for="shorten-reason-option-{{ $key }}">
                                    {{ $reason }}
                                 </label>

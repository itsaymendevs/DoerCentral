<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="edit-bundle" wire:ignore.self>
                        ...
                        <div class="col-5 mb-4">
                            <div>
                                ...
                                <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                    title="Click To Upload" for="bundle--file-2" style="height: 235px">


                                    {{-- input --}}
                                    <input class="form-control  file--input" type="file" id="bundle--file-2"
                                        data-preview="bundle--preview-2" wire:model='instance.imageFile' />



                                    {{-- image --}}
                                    <img id="bundle--preview-2" class="inventory--image-frame h-100"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-12" wire:ignore>
                                    ...
                                    <div class="select--single-wrapper mb-4" wire:loading.class='no-events-loading'>
                                        <select id='bundle--module-select-2'
                                            class="form-select form--modal-select form--modal-group-select-2"
                                            data-modal='#edit-bundle' data-instance='instance.featureModuleId' required>
                                            <option value=""></option>
                                ...
                                <table class="table table-bordered" id="memoir--table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr key='single-bundle-feature-{{ $feature?->id }}'>
                                            ...
                                            {{-- feature --}}
                                            <td class="fw-semibold fs-14">{{ $feature->name }}</td>
                                            ...
                                            <td class="fw-bold">
                                                <div class="form-check form-switch form-check-inline input--switch">
                                                    <input class="form-check-input pointer"
                                                        ...
                                                        id="bundle-feature-checkbox-edit-{{ $feature->id }}"
                                                        type="checkbox"
                                                        wire:model='instance.features.{{ $feature->id }}'>
                                                    <label class="form-check-label d-none"
                                                        for="bundle-feature-checkbox-edit-{{ $feature->id }}">Label</label>
                                                </div>
                                            </td>
    ...
    {{-- select-handle --}}
    <script>
        $(".form--modal-group-select-2").on("change", function(event) {

{{-- viewRanges --}}
<div class="modal fade modal--shadow" id="plan-ranges" role="dialog" tabindex="-1" wire:ignore.self>
      ...
      <div class="modal-content">
         <div class="modal-body py-0 px-0">
            ...
            <header class="modal--header px-4">
               <h5 class="mb-0 fw-bold text-white">Plan Ranges</h5>
            ...
            <form class="px-4" wire:submit='store'>
               <div class="row align-items-center row pt-2">
                  ...
                  <div class="col-4">
                     ...
                     <input class="form-control form--input mb-4 readonly" type="text" readonly=""
                        wire:model='instance.planName' required />
                  </div>
                  ...
                  {{-- desc --}}
                  <div class="col-9">
                     <label class="form-label form--label">Brief Descirption</label>
                     <input class="form-control form--input mb-4" type="text" wire:model='instance.desc' required />
                  </div>
            ...
            {{-- viewRanges --}}
            <div class='px-4'>
               <div class="row align-items-center row pt-2 mb-3">
                        ...
                        <table class="table table-bordered" id="memoir--table">
                           ...
                           <tbody>
                              ...
                              @foreach ($ranges as $range)
                                 <livewire:dashboard.menu.plans.components.plans-view-ranges :id='$range->id'
                                    :key='$range->id' />
                              @endforeach
                              {{-- end loop --}}

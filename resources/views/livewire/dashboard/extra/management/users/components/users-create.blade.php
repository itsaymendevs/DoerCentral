<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="new-user" wire:ignore.self>
      ...
      <div class="modal-content">
         <div class="modal-body py-0 px-0">
            ...
            <header class="modal--header px-4">
               <h5 class="mb-0 fw-bold text-white">New User</h5>
                  ...
                  <div class="col-4">
                     <div>
                        ...
                        <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                           title="Click To Upload" for="user--file-1">



                           {{-- input --}}
                           <input class="form-control d-none file--input" type="file" id="user--file-1"
                              data-preview="user--preview-1" wire:model='instance.imageFile' />


                           {{-- preview --}}
                           <img id="user--preview-1" class="inventory--image-frame"
                              src="{{ url('assets/img/placeholder.png') }}" wire:ignore.self />
                     ...
                     <div class="row">
                        ...
                        <div class="col-6">
                           ...
                           <input class="form-control form--input mb-4" type="password" required
                              wire:model='instance.password' minlength="6" />
                        </div>
                        ...
                        <div class="col-6" wire:ignore>
                           ...
                           <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                              <select class="form-select form--modal-select form--modal-role-select-1"
                                 data-modal='#new-user' data-instance='instance.roleId' required>
                                 <option value=""></option>
   ...
   {{-- select-handle --}}
   <script>
      $(".form--modal-role-select-1").on("change", function(event) {

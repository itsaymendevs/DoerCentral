                                ...
                                <div class="col-12 text-center position-relative">
                                    <div class="position-relative">
                                        ...
                                        <img class="client--card-logo"
                                            src="{{ asset('storage/menu/meals/' . ($side->imageFile ?? $defaultPlate)) }}" />
                                        ...
                                        <button class="btn client--floating-button" type="button"
                                            ...
                                            wire:click="editMenuList('{{ $side->id }}')">




                                            {{-- A: inList --}}
                                            @if ($side->isForMenu || $side->isForAddons)



                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                fill="currentColor" viewBox="0 0 16 16" class="bi bi-star-fill active">
                                                <path
                                ...
                                <div class="col-12">
                                    <div class="tabs--wrap">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            {{-- loop - sizes --}}
                                            @foreach ($side->sizes as $sideSize)
                                            <div class="tab-pane no--card py-0 px-3 @if ($initSideSizeId == $sideSize->id) active @endif"

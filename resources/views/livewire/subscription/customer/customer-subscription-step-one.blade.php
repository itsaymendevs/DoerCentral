                     ...
                     <div class="row">
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-1">
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-4 mx-2 scale--self-05 disabled"
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-4 mx-2 scale--self-05 disabled"
                                 wire:click="prepExistingCustomer({{ $plan->id }})" wire:loading.attr='disabled'>
                                 Select Plan</button>
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-2 scale--self-05 h-32 disabled"
                                 data-bs-toggle="tooltip" data-bss-tooltip="" type="button" title="View Details">

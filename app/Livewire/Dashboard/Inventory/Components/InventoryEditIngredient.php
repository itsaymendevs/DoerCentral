...
class InventoryEditIngredient extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.inventory.components.inventory-edit-ingredient', compact('categories', 'groups', 'excludes', 'allergies', 'units'));

               ...
               <div class="row row pt-2 mb-4">
                  ...
                  <div class="col-3 align-self-start">
                     ...
                     <div>
                        <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                           for="ingredient--file-2" title="Click To Upload">


                           {{-- input --}}
                           <input class="form-control d-none file--input" id="ingredient--file-2"
                              data-preview="ingredient--preview-2" type="file" wire:model='instance.imageFile' />


                           {{-- preview --}}
                           <img class="inventory--image-frame" id="ingredient--preview-2"
                  ...
                  <div class="col-3 align-self-start">
                     ...
                     <div>
                        ...
                        <textarea class="form-control form--input form--textarea mb-4" wire:model='instance.usage'
                  ...
                  <div class="col-3 align-self-start">
                     ...
                     <div>
                        ...
                        <textarea class="form-control form--input form--textarea mb-4" wire:model='instance.desc'
                           style="height:126px"></textarea>
                     </div>

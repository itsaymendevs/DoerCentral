<div class="modal fade modal--shadow" id="edit-purchase" role="dialog" tabindex="-1" wire:ignore.self>
        ...
        <div class="modal-content">
            <div class="modal-body py-0 px-0">
                ...
                <header class="modal--header px-4">
                    <h5 class="mb-0 fw-bold text-white">Edit Purchase</h5>
                    ...
                    <div class="row row pt-2 mb-4">
                        ...
                        <div class="col-4" wire:ignore>
                            ...
                            <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                                <select class="form-select form--modal-select form--modal-edit-purchase-select"
                                    id='purchase-vendor-select-2' data-modal='#edit-purchase' data-trigger='true'
                                    data-instance='instance.vendorId' required>
                                    <option value=""></option>
                        ...
                        <div class="col-4">
                            ...
                            <input class="form-control form--input mb-4 readonly" type="text" required readonly=""
                                wire:model='instance.PONumber' required />
                        </div>
    ...
    {{-- select-handle --}}
    <script>
        $(".form--modal-edit-purchase-select").on("change", function(event) {

        ...
        <div class="modal-content">
            <div class="modal-body py-0 px-0">
                ...
                <header class="modal--header px-4">
                    <h5 class="mb-0 fw-bold text-white">Wallet</h5>
                ...
                <form wire:submit='store' class="px-4">
                    <div class="row align-items-center row pt-2 mb-4">
                        ...
                        {{-- amount --}}
                        <div class="col-4">
                            <label class="form-label form--label">Amount
                        ...
                        <div class="col-3 text-center">
                            <button
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 16 16" class="bi bi-plus-circle-dotted fs-6 me-2">
                                    <path
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="th--md">Amount
                                                <small class="ms-1 fw-semibold text-theme-secondary fs-10">(AED)</small>
                                            </th>

                                            <th class="th--lg">Remarks</th>
                                            <th class="th--md">Deposit Date</th>
                                        </tr>
                                    </thead>

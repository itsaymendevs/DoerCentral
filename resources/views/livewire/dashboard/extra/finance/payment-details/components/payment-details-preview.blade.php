<div class="modal modal-xl  fade modal--shadow" role="dialog" tabindex="-1" id="invoice-preview" wire:ignore.self>
      ...
      <div class="modal-content">
         <div class="modal-body py-0 px-0">
            ...
            <header class="modal--header px-4">
               <h5 class="mb-0 fw-bold text-white">Invoice Preview</h5>
               ...
               <div class="row justify-content-center text-center">
                  ...
                  <div class="col-12 col-lg-12 col-xl-12">
                     ...
                     <div id='invoice--{{ $invoice->id }}'
                        class="text-start overview--card client-version mb-0 w-100 flex-row subscription--side-invoice no-events">
                              ...
                              <div class="row align-items-center mb-4 pb-3"
                                 ...
                                 <div class="col-12 col-sm-6 text-center text-sm-end">
                                    <img class="of-contain"
                                       src="{{ url('storage/profile/' . $globalProfile->imageFile) }}"

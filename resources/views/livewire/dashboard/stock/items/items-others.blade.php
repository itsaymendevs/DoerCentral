                            ...
                            <div class="row">
                                ...
                                <div class="col-12 text-center position-relative">
                                    <img class="client--card-logo rounded-0"
                                        src="{{ asset('storage/stock/items/others/' . $item->imageFile) }}" />
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mb-1">
                                        ...
                                        <button class="btn btn--scheme btn--scheme-outline-3 fs-12 px-2 mx-2 h-32"
                                            data-bs-toggle='modal' data-bs-target='#edit-item'
                                        ...
                                        <button class="btn btn--scheme btn--remove-outline fs-12 px-2 mx-2 h-32"
                                            type="button" wire:click="remove('{{ $item->id }}')"
                                ...
                                <div class="col-12">
                                    <div class="input--with-label mt-2">
                                        ...
                                        <input type="number" class="form--input" step="0.01" required
                                            value='{{ $item->charge }}' min='0'
                                            wire:change="updateCharge({{ $item->id }}, $event.target.value)"

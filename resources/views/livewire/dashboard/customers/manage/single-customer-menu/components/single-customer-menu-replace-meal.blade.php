         ...
         <div class="modal-body py-0 px-0" style="background-color: var(--color-scheme-2)">
            ...
            <div class="px-4">
               <div class="row justify-content-center align-items-center">
                  ...
                  {{-- search --}}
                  <div class="col-4">
                     <input wire:model.live='searchMeal' class="form-control form--input main-version mx-auto mb-5"
                        ...
                        <div class="row">
                           ...
                           <div class="col-12">
                              ...
                              <div class="d-flex align-items-center justify-content-center mb-2 mt-1">
                                 ...
                                 <button class="btn btn--scheme btn--remove fs-11 px-3 mx-1 py-1" @if($isNotAllergy &&
                                    $isNotExclude) disabled @endif type="button" data-bs-toggle='modal'
                                    data-bs-target='#replacement-excludes' wire:click='viewReplacementExcludes({{ $meal->id
                                                }})'>Excludes</button>
                  ...
                  <div class="col-12 col-sm-9 col-lg-5 col-xl-3">
                     <div class="overview--card client-version scale--self-05 mb-floating mb-5">
                        <div class="row">
                           ...
                           {{-- imageFile --}}
                           <div class="col-12 text-center position-relative"><img class="client--card-logo mt-0"
                                 src="{{ url('assets/img/plate.png') }}" />
                           </div>

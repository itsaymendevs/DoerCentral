                    ...
                    <table class="table table-bordered" id="memoir--table">
                        ...
                        <tbody>
                            ...
                            <tr key='purchase-{{ $purchase->id }}'>
                                ...
                                <td class="fw-bold">{{ $purchase->vendor->name }}</td>
                                ...
                                <td class="scale--3">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <button class="btn btn--raw-icon inline view scale--3"
                                            wire:click='manageItems({{ $purchase->id }})'
                                            data-bs-target="#purchase-items" data-bs-toggle="modal" type="button">

...
return new class extends Migration {
    ...
    {
        Schema::create('customer_subscription_extends', function (Blueprint $table) {
            $table->id();
            ...
            // 1.2: extendDays - pricePerDay - totalPrice
            $table->integer('extendDays')->nullable();
    ...
    {
        Schema::dropIfExists('customer_subscription_extends');
    }
};

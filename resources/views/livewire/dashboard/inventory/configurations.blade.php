...
<section class="content--section" id="content--section">
    <div class="container">
        ...
        {{-- :: SubMenu --}}
        <livewire:dashboard.inventory.components.sub-menu title='Configurations' key='sub-menu' />
                            ...
                            <div class="col-12">
                                <div>
                                    ...
                                    <div class="collapse collapse--content" id="collapse-1">
                                        ...
                                        {{-- :: store - view - update --}}
                                        <livewire:dashboard.inventory.configurations.components.configurations-categories />
                            ...
                            <div class="col-12">
                                <div>
                                    ...
                                    <div class="collapse collapse--content" id="collapse-2">
                                        ...
                                        {{-- :: store - view - update --}}
                                        <livewire:dashboard.inventory.configurations.components.configurations-groups />
                            ...
                            <div class="col-12">
                                <div>
                                    ...
                                    <div class="collapse collapse--content" id="collapse-3">
                                        ...
                                        {{-- :: store - view - update --}}
                                        <livewire:dashboard.inventory.configurations.components.configurations-excludes />
                            ...
                            <div class="col-12">
                                <div>
                                    ...
                                    <div class="collapse collapse--content" id="collapse-4">
                                        ...
                                        {{-- :: store - view - update --}}
                                        <livewire:dashboard.inventory.configurations.components.configurations-allergies />

<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="edit-allergy" wire:ignore.self>
        ...
        <div class="modal-content">
            <div class="modal-body py-0 px-0">
                ...
                <header class="modal--header px-4">
                    <h5 class="mb-0 fw-bold text-white">Allergy</h5>
                    ...
                    <div class="row row pt-2 mb-4">
                        ...
                        <div class="col-12" wire:ignore>
                            ...
                            <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                                <select class="form-select form--modal-select form--modal-allergy-ingredient-select"
                                    id='allergy-ingredients-select-2' data-modal='#edit-allergy'
    ...
    {{-- select-handle --}}
    <script>
        $(".form--modal-allergy-ingredient-select").on("change", function(event) {

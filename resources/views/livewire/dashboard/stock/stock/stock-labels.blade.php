<section id="content--section" class="content--section">
    <div class="container">
        ...
        {{-- :: SubMenu --}}
        <livewire:dashboard.stock.components.sub-menu title='Stock Labels' key='stock-submenu' />
        ...
        <div class="row mb-4">
            ...
            <div class="col-4 text-start d-flex align-items-center justify-content-start">
                ...
                <h3 class="fw-bold text-white scale--self-05 d-inline-block badge--scheme-2 ms-3 px-3 rounded-1 mb-0 py-1"
                    ...
                    {{ $stockItems?->groupBy('labelId')?->count() ?? 0 }}
                </h3>
                ...
                <div class="table-responsive memoir--table w-100 mb-4">
                    <table class="table table-bordered" id="memoir--table">
                        ...
                        <tbody>
                            ...
                            {{-- loop - groupByItem --}}
                            @foreach ($stockItems?->groupBy('labelId') ?? [] as $commonItem =>
                            $stockItemsByItem)
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 text-center position-relative">
                                    <img class="client--card-logo"
                                        src="{{ asset('storage/stock/items/labels/' . ($stockItemsByItem?->first()->item->imageFile ?? $defaultPreview)) }}">
                                </div>

            ...
            <div class="col-6 col-xxl-6">
                <form class="login--form" data-aos="fade-right" data-aos-duration="600" data-aos-once="true"
                    ...
                    <div class="form--password-input w-100">
                        <input id='password' class="form-control form--input mb-3" data-aos="flip-up"
                            data-aos-delay="600" data-bss-tooltip="" data-aos-once="true" type="password"
                            placeholder="Password" wire:model='password' required>

                        {{-- previewPassword --}}
                        <svg class="bi bi-eye preview--password" data-target='#password'
                            xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                            viewBox="0 0 16 16" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="bottom"
                            title="Show Password">
                            <path

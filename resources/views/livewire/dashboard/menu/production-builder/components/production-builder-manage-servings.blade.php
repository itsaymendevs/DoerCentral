...
<div>
    ...
    <div class="row align-items-center mt-5">
        <div class="col-12">
            <div class="d-flex align-items-center justify-content-between mb-3 hr--title">
                <hr style="width: 80%" />
                <label class="form-label form--label px-3 justify-content-center mb-0" style="width: 20%">Serving
                    Details</label>
            </div>
        </div>
    </div>
    ...
    {{-- tableView --}}
    <div class='row align-content-center @if ($initSizeId != $mealSize->size->id) d-none @endif'

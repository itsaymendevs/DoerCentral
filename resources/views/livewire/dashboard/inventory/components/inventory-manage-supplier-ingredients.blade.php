{{-- supplierIngredients --}}
<div class="modal fade modal--shadow" id="supplier-ingredients" role="dialog" tabindex="-1" wire:ignore.self>
        ...
        <div class="modal-content">
            <div class="modal-body py-0 px-0">
                ...
                <header class="modal--header px-4">
                    <h5 class="mb-0 fw-bold text-white">Supplier Ingredients</h5>
                            ...
                            <div class="table-responsive memoir--table">
                                <table class="table table-bordered" id="memoir--table">
                                    ...
                                    <tbody>
                                        ...
                                        {{-- :: singleIngredient --}}
                                        <livewire:dashboard.inventory.components.inventory-view-supplier-ingredient
                                            key='{{ $supplierIngredient->id }}' :id='$supplierIngredient->id' />
                                        @endforeach
                                        {{-- end loop --}}

<div class="col-3">
   ...
   <div class="select--single-wrapper mb-4 mx-auto" wire:loading.class='no-events' wire:ignore>
      <select class="form-select form--select label--select" data-clear='true' id='label-select-1' data-instance='label'
   ...
   <div>
      <img class="w-100 of-contain" id='container-preview' @if ($currentLabel)
         src="{{ url('storage/kitchen/labels/' . $currentLabel->imageFile) }}" @else
         src="{{ url('assets/img/placeholder.png') }}" @endif style="height: 170px" />
   </div>

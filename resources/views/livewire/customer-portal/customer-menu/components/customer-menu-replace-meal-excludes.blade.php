<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="replacement-excludes" wire:ignore.self>
        ...
        <div class="modal-content">
            <div class="modal-body py-0 px-0">
                ...
                <header class="modal--header px-4">
                    ...
                    <button class="btn btn--raw-icon w-auto " type="button" data-bs-toggle="modal"
                        data-bs-target='#meal-replacement'><svg xmlns="http://www.w3.org/2000/svg" width="1em"

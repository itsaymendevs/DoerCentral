<section id="content--section" class="content--section">
   <div class="container">
      ...
      {{-- :: SubMenu --}}
      <livewire:dashboard.stock.components.sub-menu title='Manage Labels' key='stock-submenu' />
      ...
      <div class="row align-items-end">
         ...
         <div class="col-auto">
            <a wire:navigate
               ...
               href="{{ route('dashboard.stock.items.createLabel') }}">
         ...
         <div class="col text-start">
            <h3 class="fw-bold text-white scale--self-05 d-inline-block badge--scheme-2 px-3 rounded-1 mb-0 py-1"
               data-bs-toggle="tooltip" data-bss-tooltip="" title="Number of Labels">
               {{ $labels->count() }}
            </h3>
         </div>
         ...
         {{-- search --}}
         <div class="col-4">
            <input wire:model.live='searchLabel' class="form--input main-version mx-auto" type="search"
      ...
      <div class="row pt-5 align-items-center mb-5">
         <div class="col-12 mt-zone-cards plans-column" data-view="standard" data-instance="1">
            <div class="row pt-2 row align-items-center mb-4">
               ...
               <div class="col-4 col-xl-3 col-xxl-3" key='single-label-{{ $label->id }}'>
                     ...
                     <div class="row">
                        ...
                        <div class="col-12 text-center position-relative">
                           <img class="client--card-logo rounded-0"
                              src="{{ url('storage/stock/items/labels/' . $label->imageFile) }}" />
                        </div>
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-1">
                              ...
                              {{-- maange --}}
                              <a wire:navigate class="btn btn--scheme btn--scheme-2 fs-12 px-4 mx-2 scale--self-05 "
                                 href="{{ route('dashboard.stock.items.editLabel', [$label->id]) }}">Manage</a>



                              {{-- remove --}}
                              <button class="btn btn--scheme btn--remove fs-12 px-2 mx-2 scale--self-05 h-32"
                                 type="button" wire:click="remove('{{ $label->id }}')" wire:loading.attr='disabled'>

      ...
      <div class="row align-items-center">
         ...
         <div class="col-3">
            <button class="btn btn--scheme btn--scheme-2 px-3 scalemix--3 py-2 d-inline-flex align-items-center"
               type="button" data-bs-target="#new-bundle" data-bs-toggle="modal"><svg xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="row row pt-2 align-items-center mb-5">
         <div class="col-12 mt-zone-cards plans-column" data-view="standard" data-instance="1">
            <div class="row pt-2 row align-items-center mb-4">
               ...
               <div class="col-4 col-xl-3 col-xxl-3" key='{{ $bundle->id }}'>
                     ...
                     <div class="row">
                        ...
                        <div class="col-12 text-center position-relative">
                           <img class="client--card-logo "
                              src="{{ url('storage/menu/plans/bundles/' . $bundle->imageFile) }}">
                        </div>
                        ...
                        <div class="col-12">
                           ...
                           <p class="text-center fs-13 fw-bold text-danger mb-2 pb-1">
                              <button
                                 ...
                                 wire:click="edit({{ $bundle->id }})" type="button" data-bs-target="#edit-bundle"
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-0 mt-1">
                              ...
                              {{-- 1: manage --}}
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-3 mx-1 scale--self-05" type="button"
                                 wire:click='manage({{ $bundle->id }})' data-bs-target="#manage-bundle"
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-1 scale--self-05 h-32"
                                 ...
                                 title="Hide Bundle" wire:click='toggleForWebsite({{ $bundle->id }})'
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-1 scale--self-05 h-32"
                                 data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="bottom" type="button"
                                 title="Show Bundle" wire:click='toggleForWebsite({{ $bundle->id }})'
                                 wire:loading.attr='disabled' wire:target='toggleForWebsite, remove'>
                              ...
                              <button class="btn btn--scheme btn--remove fs-12 px-2 mx-1 scale--self-05 h-32"
                                 type="button" wire:click='remove({{ $bundle->id }})' wire:loading.attr='disabled'
                                 wire:target='toggleForWebsite, remove'>
                                 <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 16 16" class="bi bi-trash fs-5">
                                    <path

...
<div class="col-9">
    ...
    <form wire:submit='store' class="row align-items-center">
        ...
        {{-- name --}}
        <div class="col-3">
            <label class="form-label form--label">Packing</label>
            <input wire:model='instance.name' required class="form-control form--input mb-4" type="text" />
        </div>
            ...
            <div class="table-responsive memoir--table w-100">
                <table class="table table-bordered" id="memoir--table">
                    ...
                    <tbody>
                        ...
                        {{-- :: singlePacking --}}
                        <livewire:dashboard.menu.production-builder.components.production-builder-view-packing
                            :id='$packing->id' key='{{ $packing->id }}' />

{{-- wrapper --}}
<div class="d-block builder--checkboxes-wrapper">
    ...
    <div class="mt-4 types--tags-wrapper mx-auto" id="for-recipe">
    ...
    <div class="mt-4 types--tags-wrapper mx-auto" id="for-snack">
    ...
    <div class="mt-4 types--tags-wrapper mx-auto" id="for-sauce">
        ...
        <div class="form-check mb-3 itemType--radio">
            ...
            <input class="form-check-input" id="sauceType-{{ $sauceType }}" name="sauceType" type="radio"
                value='{{ $sauceType }}' @if ($instance->partType == $sauceType) checked='checked' @endif
            wire:model='instance.partType' wire:change='update' wire:loading.attr='disabled' wire:target='update' />
    ...
    <div class="mt-4 types--tags-wrapper mx-auto" id="for-drink">
        ...
        <div class="form-check mb-3 itemType--radio">
            ...
            <input class="form-check-input" id="drinkType-{{ $drinkType }}" name="drinkType" type="radio"
                value='{{ $drinkType }}' @if ($instance->partType == $drinkType) checked='checked' @endif
            wire:model='instance.partType' wire:change='update' wire:loading.attr='disabled' wire:target='update' />
    ...
    <div class="mt-4 types--tags-wrapper mx-auto" id="for-subRecipe">
        ...
        <div class="form-check mb-3 itemType--radio">
            ...
            <input class="form-check-input" id="subRecipeType-{{ $subRecipeType }}" name="subRecipeType" type="radio"
                value='{{ $subRecipeType }}' @if ($instance->partType == $subRecipeType) checked='checked' @endif
            wire:model='instance.partType' wire:change='update' wire:loading.attr='disabled' wire:target='update' />

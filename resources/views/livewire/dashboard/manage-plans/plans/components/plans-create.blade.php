<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="new-plan" wire:ignore.self>
                    ...
                    <div class="row pt-2 mb-4">
                        ...
                        <div class="col-4">
                            <div>
                                ...
                                <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                    title="Click To Upload" for="plan--file-1" style="height: 197px">


                                    {{-- input --}}
                                    <input class="form-control  file--input" type="file" id="plan--file-1"
                                        data-preview="plan--preview-1" wire:model='instance.imageFile' required />



                                    {{-- image --}}
                                    <img id="plan--preview-1" class="inventory--image-frame h-100"
                        ...
                        <div class="col-12 mt-2">
                            <div class="row">
                                ...
                                <div class="col-6" key='single-module-{{ $module->id }}'>
                                        ...
                                        <div class="table-responsive memoir--table inline--table w-100">
                                            <table class="table table-bordered" id="memoir--table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr key='single-module-bundle-{{ $bundle?->id }}'>
                                                        ...
                                                        <td class="fw-bold">
                                                            <div
                                                                ...
                                                                <input class="form-check-input pointer"
                                                                    ...
                                                                    wire:target='resetModule, store, remount'

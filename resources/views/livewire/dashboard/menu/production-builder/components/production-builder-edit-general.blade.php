   ...
   <div class="col-7 align-self-center">
      <div class="row align-items-end">
         ...
         <div class="col-4">
            ...
            <input class="form-control form--input mb-4" type="number" wire:model='instance.servingPrice' step="0.01" />
         </div>
         ...
         <div class="col-4 text-center mt-2">
            <button
               ...
               wire:target='update, instance.imageFile, instance.secondImageFile, instance.thirdImageFile, instance.fourthImageFile, instance.tags, instance.isVegetarian, instance.cuisineId'>
               Update
            </button>
         </div>
      ...
      <div class="row" wire:ignore>
         ...
         <div class="col-6">
            <label class="col-form-label upload--wrap mb-2" data-bs-toggle="tooltip" data-bss-tooltip=""
               ...
               {{-- preview --}}
               <img class="inventory--image-frame" id="item--preview-1" src="{{ url('assets/img/placeholder.png') }}"
                  wire:ignore />
         ...
         <div class="col-6">
            <label class="col-form-label upload--wrap mb-2" data-bs-toggle="tooltip" data-bss-tooltip=""
               ...
               {{-- preview --}}
               <img class="inventory--image-frame" id="item--preview-2" src="{{ url('assets/img/placeholder.png') }}"
                  wire:ignore />
         ...
         {{-- thirdImageFile --}}
         <div class="col-6">
            <label class="col-form-label upload--wrap " data-bs-toggle="tooltip" data-bss-tooltip="" for="item--file-3"
               ...
               {{-- preview --}}
               <img class="inventory--image-frame" id="item--preview-3" src="{{ url('assets/img/placeholder.png') }}"
                  wire:ignore />
         ...
         {{-- fourthImageFile --}}
         <div class="col-6">
            <label class="col-form-label upload--wrap " data-bs-toggle="tooltip" data-bss-tooltip="" for="item--file-4"
               title="Click To Upload">
               ...
               {{-- preview --}}
               <img class="inventory--image-frame" id="item--preview-4" src="{{ url('assets/img/placeholder.png') }}"
                  wire:ignore />

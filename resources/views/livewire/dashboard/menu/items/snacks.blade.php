<section class="content--section" id="content--section">
    <div class="container">
        ...
        <div class="row">
            ...
            {{-- search --}}
            <div
                class="@if ($versionPermission->menuModuleHasMealTypeFilters || session('hasTechAccess')) col-2 @else col-3 @endif">
            ...
            {{-- sub-menu --}}
            <div
                class="@if ($versionPermission->menuModuleHasMealTypeFilters || session('hasTechAccess')) col-6 @else col-7 @endif text-end">
                                ...
                                <div class="col-12 text-center position-relative">
                                    <div class="position-relative">
                                        ...
                                        <button class="btn client--floating-button" type="button"
                                            ...
                                            wire:click="editMenuList('{{ $snack->id }}')">
                                ...
                                <div class="col-12">
                                    <div class="tabs--wrap">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            {{-- loop - sizes --}}
                                            @foreach ($snack->sizes as $snackSize)
                                            <div class="tab-pane no--card py-0 px-3 @if ($initSnackSizeId == $snackSize->id) active @endif"

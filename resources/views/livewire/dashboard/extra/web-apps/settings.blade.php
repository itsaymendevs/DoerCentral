      ...
      <div class="row pt-2 align-items-center my-5">
         <div class="col-12">
                  ...
                  <div class="col-12">
                     <div>
                        ...
                        <a class="btn fs-5 collapse--btn fw-semibold" data-bs-toggle="collapse" aria-expanded="true"
                           aria-controls="collapse-2" href="#collapse-2" role="button">Design & Colors<svg
                        ...
                        <div class="collapse collapsed collapse--content" style="border-top: 1px solid transparent"
                           ...
                           <form wire:submit='updateBlogSettings' class="row align-items-end pt-2">
                              ...
                              <div class="col-4">
                                 <div class="input--with-label mb-3">
                                    <label class="form-label form--label mb-0" style="width: 80%">Separator</label>
                                    <input type="color" class="form--input py-1 pointer" required=""
                              ...
                              <div class="col-4">
                                 <div class="input--with-label mb-3">
                                    <label class="form-label form--label mb-0" style="width: 80%">Button
                                       Shadow<i class="bi bi-info-circle" data-bs-toggle="tooltip" data-bss-tooltip=""
                                          title="Hover"></i></label>
                                    <input type="color" class="form--input py-1 pointer" required=""
                              ...
                              <div class="col-4">
                                 <div class="input--with-label mb-3">
                                    <label class="form-label form--label mb-0" style="width: 80%">Menu
                                       BG<i class="bi bi-info-circle" data-bs-toggle="tooltip" data-bss-tooltip=""
                                          title="Visible in Single Blog"></i></label>
                                    <input type="color" class="form--input py-1 pointer" required=""
                              ...
                              <div class="col-4" wire:ignore>
                                 ...
                                 <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                                    <select class="form-select form--select form--blog-select"
                                       data-instance='instance.cardAlignment' value='{{ $instance?->cardAlignment }}'>
                                       <option value=""></option>
                              ...
                              <div class="col-4" wire:ignore>
                                 <label class="form-label form--label">Blog Header<i class="bi bi-info-circle"
                                       data-bs-toggle="tooltip" data-bss-tooltip=""
                                       title="Includes: Title - Subtitle"></i></label>
                                 <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                                    <select class="form-select form--select form--blog-select"
                              ...
                              {{-- heroPictureRadius --}}
                              <div class="col-4">
                                 <label class="form-label form--label">Hero Picture Radius<i class="bi bi-info-circle"
                              ...
                              {{-- numberOfColumns --}}
                              <div class="col-4">
                                 <label class="form-label form--label">Card Columns<i class="bi bi-info-circle"
                                       data-bs-toggle="tooltip" data-bss-tooltip="" title="ex. 2 - 3 - 4"></i></label>
                                 <input class="form-control form--input mb-4" type="number" step='1' min='2' max='4'
                                    wire:model='instance.numberOfColumns' />
                              </div>
                              ...
                              <div class="col-12 mt-4">
                                 <div class="d-flex align-items-center justify-content-between mb-4">
                                    <hr class="w-75" />
                                    <label class="form-label form--label px-3 w-25 justify-content-center mb-0">Dynamic
                                       Content</label>
                                 </div>
                              </div>
                              ...
                              <div class="col-12 mb-4" wire:ignore>
                                 ...
                                 <div id='quill-editor-1' class="quill-editor" data-toolbar='#quill-editor-toolbar-1'
                                    data-value="{{ $instance->heroText ?? '' }}" data-instance='instance.heroText'>
                                 </div>
                              ...
                              {{-- contentTitleText --}}
                              <div class="col-8">
                                 <label class="form-label form--label">Section Header<i class="bi bi-info-circle"
                                       data-bs-toggle="tooltip" data-bss-tooltip="" title="ex. Our Blogs"></i></label>
               ...
               <div class="row">
                  <div class="col-12">
                     <div>
                        ...
                        {{-- togglerButton --}}
                        <a class="btn fs-5 collapse--btn fw-semibold" data-bs-toggle="collapse" aria-expanded="true"
                           aria-controls="collapse-3" href="#collapse-3" role="button">Attachments<svg
                              xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                              viewBox="0 0 16 16" class="bi bi-chevron-expand">
                              <path fill-rule="evenodd"
                                 d="M3.646 9.146a.5.5 0 0 1 .708 0L8 12.793l3.646-3.647a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 0-.708zm0-2.292a.5.5 0 0 0 .708 0L8 3.207l3.646 3.647a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 0 0 0 .708z">
                        ...
                        <div class="collapse collapse--content" style="border-top: 1px solid transparent"
                           ...
                           <form wire:submit='updateBlogAttachments' class="row pt-2">
                              ...
                              <div class="col-6">
                                 <div class="d-flex align-items-center justify-content-between mb-4">
                                    <hr class="w-75" />
                                    <label class="form-label form--label px-3 w-25 justify-content-center mb-0">Hero
                                    </label>
                                 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-6">
                                       <label class="form-label upload--wrap mb-3" data-bs-toggle="tooltip"
                                          ...
                                          {{-- input --}}
                                          <input class="form-control d-none file--input" type="file" id="hero--file-1"
                                             data-preview="hero--preview-1" wire:model='instance.heroImageFile' />
                                    ...
                                    <div class="col-6">
                                       <label class="form-label upload--wrap mb-3" data-bs-toggle="tooltip"
                                          ...
                                          {{-- input --}}
                                          <input class="form-control d-none file--input" type="file" id="hero--file-2"
                                             data-preview="hero--preview-2" wire:model='instance.heroSecondImageFile' />
                                    ...
                                    <div class="col-6">
                                       <label class="form-label upload--wrap mb-3" data-bs-toggle="tooltip"
                                          ...
                                          {{-- input --}}
                                          <input class="form-control d-none file--input" type="file" id="hero--file-3"
                                             data-preview="hero--preview-3" wire:model='instance.heroThirdImageFile' />
                                    ...
                                    <div class="col-6">
                                       <label class="form-label upload--wrap mb-3" data-bs-toggle="tooltip"
                                          ...
                                          {{-- input --}}
                                          <input class="form-control d-none file--input" type="file" id="hero--file-4"
                                             data-preview="hero--preview-4" wire:model='instance.heroFourthImageFile' />
                              ...
                              <div class="col-6">
                                 ...
                                 <div class="d-flex align-items-center justify-content-between mb-4">
                                    <hr class="w-75" />
                                    <label class="form-label form--label px-3 w-25 justify-content-center mb-0">Footer
                                    </label>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-12">
                                       <label class="form-label upload--wrap mb-3" data-bs-toggle="tooltip"
                                          data-bss-tooltip="" title="Click To Upload" for="footer--file-1">
                                          ...
                                          {{-- input --}}
                                          <input class="form-control d-none file--input" type="file" id="footer--file-1"
                                             data-preview="footer--preview-1" wire:model='instance.footerImageFile'
                                             readonly />
            ...
            <div class="tab-pane-like mt-3" style="border: 1px solid var(--color-theme-secondary)">
               ...
               <livewire:dashboard.extra.web-apps.settings.components.settings-plan-form key='settings-plan-form' />

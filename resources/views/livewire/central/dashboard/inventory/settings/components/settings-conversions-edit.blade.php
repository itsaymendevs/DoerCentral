...
<tr>
    ...
    <td>
        <div class="d-flex align-items-center justify-content-center">
            ...
            {{-- edit --}}
            <a href="{{ route('central.dashboard.inventory.settings.conversionIngredients', [$instance->id]) }}"
                class="btn btn--raw-icon inline scale--3">

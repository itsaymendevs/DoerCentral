<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="new-container" wire:ignore.self>
        ...
        <div class="modal-content">
            <div class="modal-body py-0 px-0">
                ...
                <header class="modal--header px-4">
                    <h5 class="mb-0 fw-bold text-white">New Container</h5>
                    ...
                    <div class="row align-items-center row pt-2 mb-4">
                        ...
                        <div class="col-5">
                            <label class="form-label form--label">Charge
                                <small class="ms-1 fw-semibold text-gold fs-10">(AED)</small>
                            </label>

                            <input class="form-control form--input mb-4" type="number" min='0' required step='0.01'
                        ...
                        <div class="col-12">
                            <div>
                                ...
                                <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                    title="Click To Upload" for="container--file-1">


                                    {{-- input --}}
                                    <input class="form-control d-none file--input" type="file" id="container--file-1"
                                        data-preview="container--preview-1" required wire:model='instance.imageFile' />



                                    {{-- imageFile --}}
                                    <img id="container--preview-1" class="inventory--image-frame"

   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-6 text-center">
            <input class="form--input main-version mx-auto" type="search" placeholder="Search for Recipes" />
         </div>
         ...
         <div class="col-3 text-end">
            ...
            <div class="btn-group btn--swtich-group me-3" role="group" style="margin-bottom: 10px">
               <button class="btn active btn--switch-view fw-bold" data-view="standard" data-target="plans-column"
                  ...
                  S</button><button class="btn btn--switch-view fw-bold" data-view="master" data-target="plans-column"
                  data-instance="1" type="button">
                  M
               </button>
            </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-12">
                              ...
                              <h6 class="text-center fw-bold mt-3 mb-2 truncate-text-2l height-2l">
                                 Chicken Stir Fry With Boiled Jasmine Rice
                              </h6>

                     ...
                     <div class="row">
                        ...
                        <div class="col-12 text-center position-relative">
                           <img class="client--card-logo"
                              src="{{ url('storage/menu/meals/' . ($subRecipe->imageFile ?? $defaultPlate)) }}" />
                        </div>
                        ...
                        <div class="col-12">
                           <div class="tabs--wrap">
                              ...
                              <ul class="nav nav-tabs inner for-sizes" role="tablist">
                                 ...
                                 <li class="nav-item" role="presentation">
                                    <a class="nav-link @if ($initSubRecipeSizeId == $subRecipeSize->id) active @endif"
                                       data-bs-toggle="tab" href="#tab-1-{{ $subRecipeSize->id }}" role="tab">
                              ...
                              <div class="tab-content">
                                 ...
                                 @foreach ($subRecipe->sizes as $subRecipeSize)
                                 <div
                                    class="tab-pane no--card py-0 px-3 @if ($initSubRecipeSizeId == $subRecipeSize->id) active @endif"
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-3">
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-1 scale--self-05 h-32"
                                 ...
                                 title="{{ implode(' &#8226; ', $subRecipe->partsInArray()) }}">
                              ...
                              <button class="btn btn--scheme btn--remove fs-12 px-2 mx-1 scale--self-05 h-32"
                                 wire:loading.attr='disabled' type="button" wire:click='remove({{ $subRecipe->id }})'>

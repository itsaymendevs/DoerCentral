                     ...
                     <div class="row">
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-0 mt-1">
                              ...
                              {{-- 1: manage --}}
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-4 mx-2 scale--self-05" type="button"
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-2 scale--self-05 h-32"
                                 ...
                                 wire:click='toggleForWebsite({{ $bundle->id }})' wire:loading.attr='disabled'

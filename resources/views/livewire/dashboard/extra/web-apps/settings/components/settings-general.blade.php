      ...
      <div>
         ...
         <div class="collapse  collapse--content" id="collapse-general" wire:ignore.self>
            <form wire:submit='update' class="row align-items-end pt-2 settings--row">
               ...
               {{-- fontLinks --}}
               <div class="col-12">
                  <label class="form-label form--label">Embed Links<i class="bi bi-info-circle" data-bs-toggle="tooltip"
                        data-bss-tooltip="" title="Google Fonts (URL)"></i></label>
                     ...
                     <div class="col-12">
                        <label class="form-label upload--wrap mb-3" data-bs-toggle="tooltip" data-bss-tooltip=""
                           ...
                           <input class="form-control d-none file--input" type="file" id="profile--file-1"
                              data-preview="profile--preview-1" wire:model='instance.imageFile' readonly required />
                     ...
                     <div class="col-12">
                        <label class="form-label upload--wrap mb-3" data-bs-toggle="tooltip" data-bss-tooltip=""
                           ...
                           <input class="form-control d-none file--input" type="file" id="profile--file-2"
                              data-preview="profile--preview-2" wire:model='instance.imageFileDark' readonly required />
               ...
               <div class="col-12 text-center mt-3">
                  <button wire:loading.attr='disabled' wire:target='instance.imageFile, instance.imageFileDark, update'

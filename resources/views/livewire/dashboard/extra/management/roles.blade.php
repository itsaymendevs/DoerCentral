        ...
        <div class="row align-items-center">
            ...
            <div class="col-4">
                <button class="btn btn--scheme btn--scheme-2 px-3 scalemix--3 py-2 d-inline-flex align-items-center"
                    type="button" data-bs-target="#new-role" data-bs-toggle="modal">
            ...
            <div class="col-4 text-center">
                <input type="text" class="form--input" placeholder="Search for Department"
                        ...
                        <tbody>
                            ...
                            <tr key='role-{{ $role->id }}'>
                                ...
                                <td class="text-center fw-bold text-start">
                                    <span class="d-block fs-15 fw-semibold text-gold">{{ $role->name }}</span>
                                </td>
                                ...
                                <td class="text-start">
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <button class="btn btn--raw-icon inline remove scale--3" type="button"
                                            wire:click='remove({{ $role->id }})' wire:loading.attr='disabled'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"

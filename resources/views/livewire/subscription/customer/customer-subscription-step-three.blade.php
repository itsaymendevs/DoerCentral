      ...
      <div class="row justify-content-center">
         ...
         <div class="col-12 col-xl-9 ">
            ...
            <h4 data-aos="fade" data-aos-duration="600" data-aos-delay="800" data-aos-once="true"
               class="mb-4 fw-bold text-center position-relative" wire:ignore.self>Manage Your Preferences

               {{-- :: backButton --}}
               <a class="btn submenu--group btn--scheme-2 d-flex align-items-center subscription--back-button py-1 d-none d-md-block"
                  role="button" href="{{ route('subscription.customerStepTwo', [$plan->id]) }}"><svg
            ...
            <form wire:submit='continue' class="row align-items-end mt-4 align-items-center mb-5">
               ...
               <div class="col-12 col-lg-6">
                  ...
                  {{-- imageFile --}}
                  <img class="w-100 of-contain" src="{{ url('storage/bags/' . $instance->bagImageFile) }}"
                  ...
                  <div class="mt-2 w-100 mx-auto d-flex justify-content-center">
                     ...
                     <div class="form-check itemType--radio me-3">
                        ...
                        <input id="formCheck-{{ $bag->id }}" class="form-check-input" type="radio"
                           wire:model='instance.bag' name="bag" value='{{ $bag->name }}' wire:change='changeBag'>
               ...
               {{-- bagTerms --}}
               <div class="col-12 col-lg-6 mt-4 mb-5" data-aos="fade-up" data-aos-duration="600" data-aos-delay="800"

...
class InventoryEditAllergyIngredients extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.inventory.components.inventory-edit-allergy-ingredients', compact('ingredients'));

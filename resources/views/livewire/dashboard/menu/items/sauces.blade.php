   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-2">
            <div class="select--single-wrapper" wire:loading.class='no-events' wire:ignore>
               <select class="form--select" data-instance='searchPartType' data-placeholder='Select Type'
                  ...
                  <option value="{{ $sauceType }}">{{ $sauceType }}</option>
                  @endforeach
         ...
         <div class="@if ($versionPermission->menuModuleHasMealTypeFilters) col-2 @else col-3 @endif">
            <input wire:model.live='searchSauce' class="form--input main-version mx-auto" type="search"
               style="width: 80% !important" placeholder="Search for Sauces" />
         </div>
         ...
         <div class="col-2 text-start">
            <h3 class="fw-bold text-white scale--self-05 d-inline-block badge--scheme-2 px-3 rounded-1 mb-0 py-1"
               data-bs-toggle="tooltip" data-bss-tooltip="" title="Number of Sauces">
               {{ $sauces->total() }}
            </h3>
         </div>
      ...
      <div class="row row pt-2 align-items-center mb-5">
         ...
         <div class="col-12 mt-zone-cards plans-column" data-view="standard" data-instance="1">
            <div class="row pt-2 row align-items-center mb-4">
               ...
               <div class="col-4 col-xl-3 col-xxl-3" key='single-sauce-{{ $sauce->id }}'>
                  <div class="overview--card client-version scale--self-05 mb-floating">
                     <div class="row">
                        ...
                        <div class="col-12 text-center position-relative">
                           <div class="position-relative">
                              ...
                              <img class="client--card-logo"
                                 src="{{ url('storage/menu/meals/' . ($sauce->imageFile ?? $defaultPlate)) }}" />
                              ...
                              <button class="btn client--floating-button" type="button" data-bs-target="#menu-list"
                                 data-bs-toggle="modal" wire:click="editMenuList('{{ $sauce->id }}')">
                        ...
                        <div class="col-12">
                           ...
                           <p class="text-center fs-13 fw-bold text-danger mb-0">
                              <button
                                 ...
                                 type="button">{{ $sauce->partType ?? 'Not Specified' }}</button>
                           </p>
                        </div>
                        ...
                        $initSauceSizeId = $sauce?->sizes?->first()?->id ?? null;
                        ...
                        <div class="col-12">
                           <div class="tabs--wrap">
                              ...
                              <ul class="nav nav-tabs inner for-sizes" role="tablist">
                                 ...
                                 {{-- loop - sizes --}}
                                 @foreach ($sauce->sizes as $sauceSize)
                              ...
                              <div class="tab-content">
                                 ...
                                 @foreach ($sauce->sizes as $sauceSize)
                                 <div
                                    class="tab-pane no--card py-0 px-3 @if ($initSauceSizeId == $sauceSize->id) active @endif"
                                    id="tab-1-{{ $sauceSize->id }}" role="tabpanel">
                                    ...
                                    <div class="row">
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             ...
                                             <p class="fs-12">{{ $sauceSize->afterCookCalories }}</p>
                                          </div>
                                       </div>
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             <h6 class="fs-12">P</h6>
                                             <p class="fs-12">{{ $sauceSize->afterCookProteins }}</p>
                                          </div>
                                       </div>
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             <h6 class="fs-12">C</h6>
                                             <p class="fs-12">{{ $sauceSize->afterCookCarbs }}</p>
                                          </div>
                                       </div>
                                       <div class="col-3 text-end px-2">
                                          <div class="overview--box shrink--self macros-version sm">
                                             <h6 class="fs-12">F</h6>
                                             <p class="fs-12">{{ $sauceSize->afterCookFats }}</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-3">
                              ...
                              <a class="btn btn--scheme btn--theme fs-12 px-2 mx-1 scale--self-05 h-32"
                                 href="{{ route('dashboard.menuProductionBuilder', [$sauce->id]) }}">
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-1 scale--self-05 h-32"
                                 ...
                                 title="{{ implode(' &#8226; ', $sauce->partsInArray()) }}">
                              ...
                              <button class="btn btn--scheme btn--remove fs-12 px-2 mx-1 scale--self-05 h-32"
                                 wire:loading.attr='disabled' type="button" wire:click='remove({{ $sauce->id }})'>

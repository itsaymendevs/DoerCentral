...
class ConfigurationsAllergies extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.inventory.configurations.components.configurations-allergies', compact('allergies'));

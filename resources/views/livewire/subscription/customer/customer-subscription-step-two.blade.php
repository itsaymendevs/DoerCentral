         ...
         <div class="col-12 col-lg-9 text-center">
            ...
            <h4 data-aos="fade" data-aos-duration="600" data-aos-delay="800" data-aos-once="true"
               ...
               <a class="btn submenu--group btn--scheme-2 d-flex align-items-center subscription--back-button py-1 d-none d-md-block"
                  role="button" href="{{ route('subscription.customerStepOne') }}"><svg class="bi bi-arrow-up-left me-2"
                  ...
                  <div class="tabs--wrap">
                     ...
                     <ul class="nav nav-tabs mb-0" role="tablist" data-aos="flip-up" data-aos-duration="600"
                        ...
                        <li class="nav-item" role="presentation" wire:ignore>
                           <a class="nav-link " role="tab" data-bs-toggle="tab" href="#bundle-tab-{{ $bundle->id }}"
                     ...
                     <div class="tab-content">
                        ...
                        {{-- 1: bundleTabContent --}}
                        <div class="tab-pane show fade no--card px-2" role="tabpanel" id="bundle-tab-{{ $bundle->id }}"
                           wire:ignore.self>
                                 ...
                                 <div class="overview--card client-version mb-3 py-2">
                                    <div class="row align-items-center scale--img">
                                       ...
                                       <div class="col-12 col-md-4">
                                          <img src="{{ url('storage/menu/plans/bundles/' . $bundle->imageFile) }}"
                           ...
                           <div>
                              ...
                              <ul class="nav nav-tabs inner" role="tablist">
                                 ...
                                 <li class="nav-item" role="presentation" wire:ignore>
                                    <a class="nav-link" role="tab" data-bs-toggle="tab"
                                       ...
                                       wire:loading.class='disabled' wire:target='changeRange, changeBundle'>
                              ...
                              <div class="tab-content">
                                 ...
                                 <div class="tab-pane no--card px-2" role="tabpanel"
                                    id="bundle-tab-{{ $bundle->id }}-{{ $bundleRange->range->id }}" wire:ignore.self>
                                       ...
                                       <div class="row align-items-end row pt-2 align-items-center mb-4">
                                          ...
                                          <div class="col-12 col-sm-4 mb-3 mb-sm-0" wire:ignore
                                             ...
                                             <div class="select--single-wrapper text-start">
                                                <select class="form-select form--select planDays--select"
                                          ...
                                          <div class="col-12 col-sm-4 mb-3 mb-sm-0">
                                             ...
                                             <input type="date" required class="form--input mb-0"
                                                wire:model='instance.startDate' wire:loading.class='disabled'
                                          ...
                                          <div
                                             ...
                                             <h5 data-bs-toggle="tooltip" data-bss-tooltip=""
                                                ...
                                                0 }}<small class="fw-semibold text-theme-secondary fs-10 ms-1">(Calorie)
                                                </small>
                                             </h5>
                                                   ...
                                                   <div class="col-12">
                                                      ...
                                                      <div class="row justify-content-center">
                                                         <div class="col-12">
                                                            ...
                                                            <p class="text-center fs-14 fw-normal mb-0">
                                                            ...
                                                            {{-- types --}}
                                                            <p class="text-center fs-12 fw-normal text-gold mb-0">
                                                               {{ implode(' • ',
                                                               $bundle->typesInArray()) }}
                                                            </p>
                                                         ...
                                                         <div class="col-6 col-sm-4">
                                                            ...
                                                            <div class="range--input-wrapper mb-4">
                                                               ...
                                                               <input type="number"
                                                                  ...
                                                                  class="form--input range--input" step="1" min="0"
                                                               ...
                                                               <input type="number"
                                                                  data-type='{{ $bundleType->mealType->id }}'
                                                                  class="form--input range--input" step="1" min="0"
                                                                  max='1' data-input="bundle-{{ $bundle->id}}-range-type-{{
                                                                                    $bundleType->mealType->id }}"
                                                                  wire:model='instance.bundleTypes.{{
                                                                                    $bundleType->mealType->id }}' />
                                                               ...
                                                               {{-- :: plusButton --}}
                                                               <button class="btn btn--scheme px-2 range--button plus"

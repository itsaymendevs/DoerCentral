                  ...
                  <tbody>
                     ...
                     <tr key='packing-row-{{ $scheduleMealsBySubscription?->first()?->id }}'>
                        ...
                        <td class="text-start">
                           ...
                           <span class="d-block fs-13 kitchen--table-remarks" style="border-color: var(--bs-danger)">
                        ...
                        <td class="text-start">
                           ...
                           <img class='w-100 of-contain' style="height: 130px"
                              src="{{ url('storage/menu/meals/' . ($scheduleMealsBySubscription?->first()?->meal?->imageFile ?? $defaultPlate)) }}">

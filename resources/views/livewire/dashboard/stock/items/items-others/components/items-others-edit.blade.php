<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="edit-item" wire:ignore.self>
      ...
      <div class="modal-content">
         <div class="modal-body py-0 px-0">
            ...
            <header class="modal--header px-4">
               <h5 class="mb-0 fw-bold text-white">Edit Item</h5>
                  ...
                  <div class="col-12">
                     <div>
                        ...
                        <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                           title="Click To Upload" for="item--file-2">


                           {{-- input --}}
                           <input class="form-control d-none file--input" type="file" id="item--file-2"
                              data-preview="item--preview-2" wire:model='instance.imageFile' />



                           {{-- imageFile --}}
                           <img id="item--preview-2" class="inventory--image-frame"

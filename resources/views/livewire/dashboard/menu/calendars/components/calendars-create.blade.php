<div class="modal fade modal--shadow" role="dialog" tabindex="-1" id="new-calendar" wire:ignore.self>
                     ...
                     <div class="row">
                        ...
                        <div class="col-12" wire:ignore>
                           ...
                           <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                              <select class="form-select form--modal-select form--modal-create-calendar-select"
                                 data-modal='#new-calendar' data-instance='instance.diets' multiple>
                        ...
                        <div class="col-12" wire:ignore>
                           ...
                           <div class="select--single-wrapper mb-4" wire:loading.class='no-events'>
                              <select class="form-select form--modal-select form--modal-create-calendar-select"
                                 data-modal='#new-calendar' data-instance='instance.plans' multiple>
   ...
   {{-- select-handle --}}
   <script>
      $(".form--modal-create-calendar-select").on("change", function(event) {

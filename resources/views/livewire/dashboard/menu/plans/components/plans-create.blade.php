                        ...
                        <div class="col-4">
                           ...
                           <div class="d-flex mb-3">
                              <label class="form-label upload--wrap w-100" data-bs-toggle="tooltip" data-bss-tooltip=""
                                 ...
                                 {{-- preview --}}
                                 <img class="inventory--image-frame" style="height: 293px;" id="plan--preview-1"
                           ...
                           <div class='d-flex'>
                              <label class="form-label upload--wrap w-100" data-bs-toggle="tooltip" data-bss-tooltip=""
                                 ...
                                 {{-- preview --}}
                                 <img class="inventory--image-frame" id="plan--preview-2" style="height: 293px;"
                                    src="{{ url('assets/img/placeholder.png') }}" wire:ignore />
                        ...
                        <div class="col-8">
                           <div class="row">
                              ...
                              <div class="col-12">
                                 ...
                                 <textarea class="form-control form--input form--textarea mb-4" style="height: 170px"
                        ...
                        <div class='col-6 mb-4'>
                           <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                              ...
                              <input class="form-control d-none file--input" id="plan--file-3"
                                 data-preview="plan--preview-3" type="file" wire:model='instance.thirdImageFile' />
                        ...
                        <div class='col-6 mb-4'>
                           <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                              ...
                              <input class="form-control d-none file--input" id="plan--file-4"
                                 data-preview="plan--preview-4" type="file" wire:model='instance.fourthImageFile' />
                        ...
                        <div class='col-6'>
                           <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                              ...
                              <input class="form-control d-none file--input" id="plan--file-6"
                                 data-preview="plan--preview-6" type="file" wire:model='instance.sixthImageFile' />
                        ...
                        <div class='col-6'>
                           <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                              ...
                              <input class="form-control d-none file--input" id="plan--file-5"
                                 data-preview="plan--preview-5" type="file" wire:model='instance.fifthImageFile' />

               ...
               <div class="row align-items-end pt-2 mb-4">
                  ...
                  <div class="col-4" wire:ignore>
                     ...
                     <div class="select--single-wrapper mb-4">
                        <select class="form-select form--modal-select" id='shift-select-2' data-modal='#edit-driver'
                  ...
                  <div class="col-6">
                     ...
                     <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                        ...
                        {{-- preview --}}
                        <img class="inventory--image-frame" id="driver--preview-3"
                  ...
                  <div class="col-6">
                     ...
                     <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                        ...
                        {{-- preview --}}
                        <img class="inventory--image-frame" id="driver--preview-4"
                           src="{{ asset('assets/img/placeholder.png') }}" wire:ignore />

                  ...
                  <div class="col-3">
                     ...
                     <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                        ...
                        <input class="form-control d-none file--input" id="vehicle--file-1"
                           data-preview="vehicle--preview-1" type="file" wire:model='instance.imageFile' required />
                  ...
                  <div class="col-3">
                     ...
                     <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                        ...
                        <input class="form-control d-none file--input" id="plate--file-1"
                           data-preview="plate--preview-1" type="file" wire:model='instance.plateFile' required />
                  ...
                  <div class="col-3">
                     ...
                     <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                        ...
                        <input class="form-control d-none file--input" id="insurance--file-1"
                           data-preview="insurance--preview-1" type="file" wire:model='instance.insuranceFile' />
                  ...
                  <div class="col-3">
                     ...
                     <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                        ...
                        <input class="form-control d-none file--input" id="ownership--file-1"
                           data-preview="ownership--preview-1" type="file" wire:model='instance.ownershipFile' />

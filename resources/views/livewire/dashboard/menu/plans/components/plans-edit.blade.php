<div class="modal fade modal--shadow" id="edit-plan" role="dialog" tabindex="-1" wire:ignore.self>
               ...
               <div class="row align-items-start justify-content-center pt-2 mb-4">
                     ...
                     <div class="row justify-content-center">
                        ...
                        <div class="col-4">
                           ...
                           <div class="d-flex mb-3">
                              <label class="form-label upload--wrap w-100" data-bs-toggle="tooltip" data-bss-tooltip=""
                                 for="plan--file-7" title="Click To Upload">


                                 {{-- input --}}
                                 <input class="form-control d-none file--input" id="plan--file-7"
                                    data-preview="plan--preview-7" type="file" wire:model='instance.imageFile' />

                                 {{-- preview --}}
                                 <img class="inventory--image-frame" style="height: 293px;" id="plan--preview-7"
                           ...
                           <div class='d-flex'>
                              <label class="form-label upload--wrap w-100" data-bs-toggle="tooltip" data-bss-tooltip=""
                                 for="plan--file-8" title="Click To Upload">


                                 {{-- input --}}
                                 <input class="form-control d-none file--input" id="plan--file-8"
                                    data-preview="plan--preview-8" type="file" wire:model='instance.secondImageFile' />



                                 {{-- preview --}}
                                 <img class="inventory--image-frame" style="height: 293px;" id="plan--preview-8"
                                    src="{{ url('assets/img/placeholder.png') }}" wire:ignore />
                        ...
                        <div class="col-8">
                           <div class="row">
                              ...
                              <div class="col-12">
                                 ...
                                 <textarea class="form-control form--input form--textarea mb-4" style="height: 120px"
                              ...
                              <div class="col-12">
                                 ...
                                 <textarea class="form-control form--input form--textarea mb-4" style="height: 172px"
                     ...
                     <div class="row">
                        ...
                        <div class='col-6 mb-4'>
                           <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                              for="plan--file-9" title="Click To Upload">
                              ...
                              {{-- input --}}
                              <input class="form-control d-none file--input" id="plan--file-9"
                                 data-preview="plan--preview-9" type="file" wire:model='instance.thirdImageFile' />


                              {{-- preview --}}
                              <img class="inventory--image-frame" id="plan--preview-9"
                                 src="{{ url('assets/img/placeholder.png') }}" wire:ignore />
                        ...
                        <div class='col-6 mb-4'>
                           <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                              for="plan--file-10" title="Click To Upload">
                              ...
                              {{-- input --}}
                              <input class="form-control d-none file--input" id="plan--file-10"
                                 data-preview="plan--preview-10" type="file" wire:model='instance.fourthImageFile' />



                              {{-- preview --}}
                              <img class="inventory--image-frame" id="plan--preview-10"
                                 src="{{ url('assets/img/placeholder.png') }}" wire:ignore />
                        ...
                        <div class='col-6'>
                           <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                              for="plan--file-12" title="Click To Upload">
                              ...
                              {{-- input --}}
                              <input class="form-control d-none file--input" id="plan--file-12"
                                 data-preview="plan--preview-12" type="file" wire:model='instance.sixthImageFile' />

                              {{-- preview --}}
                              <img class="inventory--image-frame" id="plan--preview-12"
                                 src="{{ url('assets/img/placeholder.png') }}" wire:ignore />
                        ...
                        <div class='col-6'>
                           <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                              for="plan--file-11" title="Click To Upload">
                              ...
                              {{-- input --}}
                              <input class="form-control d-none file--input" id="plan--file-11"
                                 data-preview="plan--preview-11" type="file" wire:model='instance.fifthImageFile' />

                              {{-- preview --}}
                              <img class="inventory--image-frame" id="plan--preview-11"
                                 src="{{ url('assets/img/placeholder.png') }}" wire:ignore />
                           ...
                           <div class="table-responsive memoir--table">
                              <table class="table table-bordered" id="memoir--table">
                                 ...
                                 <tbody>
                                    ...
                                    <tr key='single-plan-point-edit-{{ $key }}'>
                  ...
                  <div class="col-12 text-center mt-4">
                     <button
                        ...
                        wire:target='instance.imageFile, instance.secondImageFile, instance.thirdImageFile, instance.fourthImageFile, instance.fifthImageFile, instance.sixthImageFile, update'>
                        Update
                     </button>
                  </div>

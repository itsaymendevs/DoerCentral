                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 text-center position-relative">
                                                        <img class="client--card-logo"
                                                            src="{{ asset('storage/menu/meals/' . ($item->imageFile ?? $defaultPlate)) }}" />
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <p class="text-center mb-2">
                                                            ...
                                                            as $singleType)
                                                            <span
                                                                class="fs-13 text-warning scale--3 recipe--card-tag ">{{
                                                    ...
                                                    <div class="col-12">
                                                        <div class="tabs--wrap">
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                {{-- 1: sizeTab --}}
                                                                <div class="tab-pane no--card py-0 px-3 @if ($item->sizes->first()->id == $mealSize->id) active @endif"
                                                                    id="tab-{{ $item->id }}-{{ $mealSize->id }}"
                                                                    role="tabpanel">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-3 text-end px-2">
                                                                            <div
                                                                                class="overview--box shrink--self macros-version sm">
                                                        ...
                                                        <div class="row mx-0 align-items-center">
                                                            ...
                                                            <div class="col-8">
                                                                ...
                                                                <div class="range--input-wrapper">
                                                                    ...
                                                                    {{-- input --}}
                                                                    <input
                                                                        class="form-control form--input range--input darker"
                                                                        type="number" step="1" min="0"
                                                                        data-input="{{ $item->id }}-range-1"
                                                                        wire:model='instance.mealTypes.{{ $item->id }}'
                                                                        data-instance='instance.mealTypes.{{ $item->id }}'
                                                                        required />
                                                            ...
                                                            <div class="col-4 px-2">
                                                                ...
                                                                <button
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                                                        ...
                                                                        class="bi bi-cart-plus-fill fs-5"
                                                                        viewBox="0 0 16 16">
                                                                        <path

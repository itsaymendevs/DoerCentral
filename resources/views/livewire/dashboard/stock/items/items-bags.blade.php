      ...
      <div class="row pt-5 mb-5">
         ...
         <form wire:submit='update' class="col-4">
            ...
            <div class="mb-4">
               ...
               <label class="form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip="" for="bag--file-1"
                  ...
                  {{-- preview --}}
                  <img class="inventory--image-frame" id="bag--preview-1" src="{{ url('assets/img/placeholder.png') }}"
                     wire:ignore />

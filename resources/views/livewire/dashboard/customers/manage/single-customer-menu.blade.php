            ...
            <div class="col-4">
                ...
                <div class="text-center mb-4">
                    ...
                    <button class="btn btn--scheme btn--remove align-items-center d-inline-flex px-3 fs-12 scale--3
                        @if ($deliveryStatus == 'No Delivery') disabled @endif" type="button"
                    ...
                    <button
                        class="btn btn--scheme btn--scheme-1 align-items-center d-inline-flex px-3 fs-12 scale--3 fw-semibold @if ($deliveryStatus == 'No Delivery') disabled @endif"

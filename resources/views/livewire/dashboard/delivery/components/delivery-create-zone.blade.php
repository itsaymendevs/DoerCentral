                    ...
                    <div class="row align-items-end pt-2 mb-4">
                        ...
                        <div class="col-5">
                            ...
                            <label class="col-form-label upload--wrap" data-bs-toggle="tooltip" data-bss-tooltip=""
                                ...
                                <input class="form-control d-none file--input" id="zone--file-1"
                                    data-preview="zone--preview-1" type="file" wire:model='instance.imageFile'
                                    required />
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input class="form-control form--input mb-4" type="text"
                                        wire:model.live='instance.name' required />
                                </div>

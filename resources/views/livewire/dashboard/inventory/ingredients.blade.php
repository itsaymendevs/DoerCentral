      ...
      <div class="row mb-4">
         ...
         <div class="col-4  d-flex align-items-center justify-content-end">
            ...
            <div class="btn-group btn--swtich-group" role="group" wire:ignore>
               ...
               {{-- cardView --}}
               <button class="btn btn--switch-view" data-view="cards" data-target="ingredients-column" data-instance="1"
                  type="button">
                        ...
                        <div class="col-12">
                           ...
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-2">
                              ...
                              <button class="btn btn--scheme btn--scheme-2 px-2 py-1 mx-1 text-white scale--3"
                                 ...
                                 type="button" wire:click="editBrands({{ $ingredient->id }})">
                                 <svg class="bi bi-tags" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                    fill="currentColor" viewBox="0 0 16 16">
                                    <path
                              ...
                              <button
                                 ...
                                 type="button" wire:click="remove({{ $ingredient->id }})" wire:loading.attr='disabled'>
                                 <svg class="bi bi-trash" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                    fill="currentColor" viewBox="0 0 16 16">
                                    <path
                           ...
                           <div class="d-flex align-items-center justify-content-center">
                              ...
                              <button class="btn btn--raw-icon inline scale--3 px-2" data-bs-toggle="modal"
                                 ...
                                 <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 16 16" class="bi bi-tags">
                                    <path
                                       d="M3 2v4.586l7 7L14.586 9l-7-7H3zM2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2z">
                                    </path>
                                    <path

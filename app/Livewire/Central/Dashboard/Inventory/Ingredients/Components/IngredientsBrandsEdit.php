...
namespace App\Livewire\Central\Dashboard\Inventory\Ingredients\Components;
...
class IngredientsBrandsEdit extends Component
{
    ...
    public function update()
    {
        ...
        // 1: makeRequest
        $response = $this->makeRequest('central/dashboard/inventory/ingredients/brands/update', $this->instance);
    ...
    public function confirmRemove()
    {
        ...
        if ($this->removeId) {
            ...
            // 1.2: makeRequest
            $response = $this->makeRequest('central/dashboard/inventory/ingredients/brands/remove', $this->removeId);
    ...
    public function render()
    {
        ...
        return view('livewire.central.dashboard.inventory.ingredients.components.ingredients-brands-edit');

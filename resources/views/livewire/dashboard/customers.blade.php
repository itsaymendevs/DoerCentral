   ...
   <div class="container">
      ...
      <div class="row align-items-center mb-3">
         ...
         <div class="col-2 text-end">
            <a href="{{ $globalProfile?->plansURL }}" target="_blank"
               class="btn btn--scheme btn--scheme-2 w-100 scalemix--3 py-2 d-inline-flex align-items-center justify-content-center"><svg
         ...
         <div class="col-2">
            <a href="{{ route('portals.customer.login') }}" target="_blank"
               class="btn btn--scheme btn--scheme-2 w-100 scale--3 py-2 d-inline-flex align-items-center justify-content-center"><svg
                  xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                  class="bi bi-arrow-up-left fs-5 me-2" viewBox="0 0 16 16">
         ...
         {{-- total --}}
         <div class="col text-end" data-aos="fade-up" data-aos-duration="600" data-aos-delay="800" data-aos-once="true"
            wire:ignore.self>
                     ...
                     <div class="row">
                        ...
                        <div class="col-12 text-center position-relative">
                           <img class="client--card-logo"
                              src="{{ url('assets/img/Customers/' . $customer->gender . '.png') }}">
                        </div>
                        ...
                        <div class="col-12">
                           <div class="d-flex align-items-center justify-content-center mb-1 mt-3">
                              ...
                              {{-- 1: manage --}}
                              <a wire:navigate class="btn btn--scheme btn--theme fs-12 px-2 mx-1 scale--self-05 h-32"
                              ...
                              <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-1 scale--self-05 h-32
                                 ...
                                 title="Re-New" wire:click='reNew({{ $customer->id }})'
                                 wire:loading.attr='disabled'><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                 ...
                                 @if ($allowedPauseDate <= $customer->currentSubscription()->untilDate)
                                    ...
                                    <button class="btn btn--scheme btn--scheme-2 fs-12 px-2 mx-1 scale--self-05 h-32"
                                       ...
                                       <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                          fill="currentColor" class="bi bi-stopwatch fs-5" viewBox="0 0 16 16">
                              ...
                              <button class="btn btn--scheme btn--remove fs-12 px-2 mx-2 scale--self-05 h-32"
                                 type="button" wire:click='remove({{ $customer->id }})' wire:loading.attr='disabled'
                                 wire:target='remove'>

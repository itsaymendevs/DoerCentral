<section id="content--section" class="content--section">
    <div class="container">
        ...
        <div class="row align-items-center pt-3 mb-3">
            ...
            <div class="col-8">
                <button
                    class="btn btn--scheme btn--scheme-2 px-3 scalemix--3 py-2 d-inline-flex align-items-center fs-xs-13 d-none"
            ...
            <div class="col-12">
                ...
                <div class="tabs--wrap">
                    ...
                    <div class="tab-content mb-4">
                        ...
                        {{-- tabPane --}}
                        <div key="address-{{ $address->id }}" class="tab-pane fade pb-0
                        @if ($addresses->first()->id == $address->id) show active @endif no--card px-1"
                            ...
                            <livewire:customer-portal.customer-addresses.components.customer-addresses-view
                                key="address-view-{{ $address->id }}" id="{{ $address->id }}" counter='{{ $key }}' />

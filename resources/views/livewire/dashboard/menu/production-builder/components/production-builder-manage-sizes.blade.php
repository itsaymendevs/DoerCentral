...
<form class="row justify-content-center align-items-end" wire:submit='store'>
    ...
    {{-- availableSizes --}}
    <div class="col-6">
        <div class="select--single-wrapper text-center" wire:loading.class='no-events' wire:ignore>
            <select class="form-select form--select size--select" id='size-select-1' data-instance='size'
                data-placeholder='Select Size' required data-clear='true'>

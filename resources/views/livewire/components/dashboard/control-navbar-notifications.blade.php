...
<div class="col-1 text-center " data-aos="fade-left" data-aos-duration="800" data-aos-once="true" style="z-index:10"
   ...
   <audio controls preload id='alertAudio' class='d-none'>
      <source src="{{ url('assets/audio/alert-2.mp3') }}" type="audio/mp3">
   </audio>
   ...
   <div class="dropstart">
      ...
      {{-- bellButton --}}
      <button class="btn btn--raw-icon navbar--notify" aria-expanded="false" data-bs-toggle="dropdown" type="button">

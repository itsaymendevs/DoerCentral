         ...
         <div class="col-12 col-sm-6 col-md-6 mb-2 mb-sm-4">
            <div class="text-center">
               ...
               <button
                  ...
                  <svg class="bi bi-arrow-right fs-5 me-2" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
               ...
               <button
                  ...
                  <svg class="bi bi-arrow-left fs-5 me-2" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                     fill="currentColor" viewBox="0 0 16 16">
                     <path fill-rule="evenodd"
         ...
         <div class="col-12 col-sm-6 col-md-6">
            ...
            <div class="text-center  text-md-center mb-4">
               ...
               <button class="btn btn--scheme btn--remove align-items-center d-inline-flex px-3 fs-12 scale--3
                  ...
                  wire:target='skipScheduleDay, unSkipScheduleDay'>
               ...
               <button class="btn btn--scheme btn--scheme-1 align-items-center d-inline-flex px-3 fs-12 scale--3 fw-semibold @if ($deliveryStatus == 'No Delivery') disabled @endif
                  ...
                  wire:target='unSkipScheduleDay, skipScheduleDay'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                     viewBox="0 0 16 16" class="bi bi-skip-end fs-5 me-2">
                     <path
                        d="M12.5 4a.5.5 0 0 0-1 0v3.248L5.233 3.612C4.713 3.31 4 3.655 4 4.308v7.384c0 .653.713.998 1.233.696L11.5 8.752V12a.5.5 0 0 0 1 0V4zM5 4.633 10.804 8 5 11.367V4.633z">
            ...
            <div class="tabs--wrap for-mobile for-menu">
               ...
               <div class="tab-content mt-0 mt-lg-0">
                  ...
                  <div class="tab-pane fade show no--card px-1
                     ...
                     {{-- mainRow --}}
                     <div class="row align-items-center mt-cards justify-content-center justify-content-md-start">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-12 text-center position-relative">
                                    <img class="client--card-logo"
                                       src="{{ url('storage/menu/meals/' . ($subscriptionScheduleMeal?->meal?->imageFile ?? $defaultPlate)) }}" />
                                 ...
                                 <div class="col-12">
                                    ...
                                    {{-- diet--}}
                                    <div class="d-flex align-items-center justify-content-center mb-3 d-none">
                                       <button
                                    ...
                                    {{-- Actions (HIDDEN) --}}
                                    <div class="d-flex align-items-center justify-content-center mb-2 mt-1 d-none">
                                 ...
                                 <div class="col-12 mt-1">
                                    <div class="row justify-content-center">
                                       ...
                                       {{-- 1: calories --}}
                                       <div class="col-auto text-end px-1">
                                          <div class="overview--box shrink--self macros-version for-calories sm">
                                       ...
                                       {{-- 2: proteins --}}
                                       <div class="col-auto text-end px-1">
                                          <div class="overview--box shrink--self macros-version for-proteins sm">
                                             <h6 class="fs-12">P</h6>
                                             <p class="fs-12">
                                                {{ $subscriptionScheduleMeal?->meal
                                       ...
                                       {{-- carbs --}}
                                       <div class="col-auto text-end px-1">
                                          <div class="overview--box shrink--self macros-version for-carbs sm">
                                             <h6 class="fs-12">C</h6>
                                             <p class="fs-12">
                                                {{ $subscriptionScheduleMeal?->meal
                                       ...
                                       {{-- fats --}}
                                       <div class="col-auto text-end px-1">
                                          <div class="overview--box shrink--self macros-version for-fats sm">
                                             <h6 class="fs-12">F</h6>
                                             <p class="fs-12">
                                                {{ $subscriptionScheduleMeal?->meal
                        ...
                        <div class="col-10 col-sm-6 col-lg-4 col-xl-3 mb-0 mb-lg-5"
                           ...
                           <div class="overview--card client-version menu scale--self-05 mb-floating">
                              <div class="row">
                                 ...
                                 <div class="col-12 text-center position-relative">
                                    <img class="client--card-logo"
                                       src="{{ url('storage/menu/meals/' . ($calendarScheduleMeal?->meal->imageFile ?? $defaultPlate)) }}" />
                                 ...
                                 <div class="col-12">
                                    <div class="d-flex align-items-center justify-content-center mt-3">
                                       ...
                                       <button
                                          ...
                                          type="button" wire:loading.attr='disabled' wire:target='changeMeal'
                        ...
                        <div class="col-10 col-sm-6 col-lg-4 col-xl-3 mb-0 mb-lg-5"
                           ...
                           <div class="overview--card client-version menu scale--self-05 mb-floating">
                              <div class="row">
                                 ...
                                 <div class="col-12 text-center position-relative">
                                    <img class="client--card-logo"
                                       src="{{ url('storage/menu/meals/' . ($subscriptionScheduleReplacement?->replacement?->imageFile ?? $defaultPlate)) }}" />
